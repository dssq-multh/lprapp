...
`)}
        }`},getRunData:()=>({outputs:[{dims:c,dataType:a}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...W(l,c)]})}},_r=(e,t)=>{let n=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(e=>n.push(Number(e))),B({axes:n,keepDims:t.keepDims,noopWithEmptyAxes:t.noopWithEmptyAxes})},vr=(e,t,n,r)=>{let i=e.inputs,a=i.length===1?n:_r(i,n);e.compute(gr(t,{hint:a.cacheKey,inputDependencies:[`rank`]},[i[0]],a.noopWithEmptyAxes&&a.axes.length===0?hr:r,a.axes,i[0].dataType,a.keepDims,a.noopWithEmptyAxes),{inputs:[0]})},yr=(e,t)=>{mr(e.inputs),vr(e,`ReduceLogSum`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += ${e.getByIndices(`input_indices`)};`,`value = log(value);`])},br=(e,t)=>{mr(e.inputs),vr(e,`ReduceL1`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += abs(${e.getByIndices(`input_indices`)});`,``])},xr=(e,t)=>{mr(e.inputs),vr(e,`ReduceL2`,t,(e,t)=>[`var t = ${t.type.value}(0); var value = ${t.type.value}(0);`,``,`t = ${e.getByIndices(`input_indices`)}; value += (t * t);`,`value = sqrt(value);`])},X=(e,t)=>{mr(e.inputs),vr(e,`ReduceLogSumExp`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += exp(${e.getByIndices(`input_indices`)});`,`value = log(value);`])},Sr=(e,t)=>{mr(e.inputs),vr(e,`ReduceMax`,t,(e,t,n)=>{let r=[];for(let t=0;t<e.rank;t++)(n.indexOf(t)>=0||n.length===0)&&r.push(e.indicesSet(`input_indices`,t,0));return[`${r.join(`
`)}`,`var value = ${e.getByIndices(`input_indices`)};`,`value = max(value, ${e.getByIndices(`input_indices`)});`,``]})},Cr=(e,t)=>{mr(e.inputs),vr(e,`ReduceMean`,t,(t,n,r)=>{let i=1;for(let n=0;n<t.rank;n++)(r.indexOf(n)>=0||r.length===0)&&(i*=e.inputs[0].dims[n]);return[`var sum = f32(0);`,``,`sum += f32(${t.getByIndices(`input_indices`)});`,`let value = ${n.type.value}(sum / ${i});`]})},Z=(e,t)=>{mr(e.inputs),vr(e,`ReduceMin`,t,(e,t,n)=>{let r=[];for(let t=0;t<e.rank;t++)(n.indexOf(t)>=0||n.length===0)&&r.push(`input_indices[${t}] = 0;`);return[`${r.join(`
`)}`,`var value = ${e.getByIndices(`input_indices`)};`,`value = min(value, ${e.getByIndices(`input_indices`)});`,``]})},wr=(e,t)=>{mr(e.inputs),vr(e,`ReduceProd`,t,(e,t)=>[`var value = ${t.type.storage}(1);`,``,`value *= ${e.getByIndices(`input_indices`)};`,``])},Q=(e,t)=>{mr(e.inputs),vr(e,`ReduceSum`,t,(e,t)=>[`var value = ${t.type.storage}(0);`,``,`value += ${e.getByIndices(`input_indices`)};`,``])},Tr=(e,t)=>{mr(e.inputs),vr(e,`ReduceSumSquare`,t,(e,t)=>[`var t = ${t.type.value}(0); var value = ${t.type.value}(0);`,``,`t = ${e.getByIndices(`input_indices`)}; value += t * t;`,``])},Er=(e,t,n)=>{if(t.length===0)return n;let r=1,i=1;for(let n=0;n<t.length;n++)t.indexOf(n)===-1?r*=e[n]:i*=e[n];return i<32&&r>1024},Dr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Cr(e,t):rr(e,t)},Or=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?br(e,t):ir(e,t)},kr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?xr(e,t):ar(e,t)},Ar=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?X(e,t):or(e,t)},jr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Sr(e,t):sr(e,t)},Mr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Z(e,t):cr(e,t)},Nr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?wr(e,t):lr(e,t)},Pr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Q(e,t):ur(e,t)},Fr=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Tr(e,t):dr(e,t)},Ir=(e,t)=>{Er(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?yr(e,t):fr(e,t)}}),Rr,zr,Br,Vr,Hr=d(()=>{I(),V(),Lr(),Rr=e=>{if(!e||e.length===0||e.length>2)throw Error(`ArgMinMaxOp op requires 1 or 2 inputs.`);if(e[0].dataType!==1)throw Error(`Invalid input type.`)},zr=(e,t)=>{Rr(e.inputs),e.compute(gr(`ArgMin`,{hint:t.cacheKey,inputDependencies:[`rank`]},[e.inputs[0]],(e,n,r)=>{let i=[];for(let t=0;t<e.rank;t++)(r.indexOf(t)>=0||r.length===0)&&i.push(`input_indices[${t}] = 0;`);return[`${i.join(`
...
var best_index : i32 = 0;`,`if (${e.getByIndices(`input_indices`)} ${t.selectLastIndex>0?`>=`:`>`} value) {
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l?[{type:12,data:c},...W(a)]:[{type:12,data:c}]})}},ei=e=>B(e),ti=(e,t)=>{let{inputs:n,outputCount:r}=e,i=ei({...t,outputCount:r});if(D.webgpu.validateInputContent&&Qr(n,i),t.trainingMode)throw Error(`BatchNormalization trainingMode is not supported yet.`);e.compute($r(n,i))}}),ri,ii,ai,oi=d(()=>{z(),Y(),ri=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![320,640,1280].includes(e[0].dims[2]))throw Error(`number of channels should be 320, 640 or 1280`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},ii=e=>{let t=e[0].dims,n=e[0].dims[2],r=R.size(t)/4,i=e[0].dataType,a=q(`input`,i,t,4),o=q(`bias`,i,[n],4),s=q(`residual`,i,t,4),c=J(`output`,i,t,4);return{name:`BiasAdd`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:e=>`
  ...
  }`}},ai=e=>{ri(e.inputs),e.compute(ii(e.inputs))}}),si,$,ci,li,ui,di,fi,pi,mi,hi,gi,_i,vi,yi,bi,xi,Si,Ci,wi,Ti,Ei,Di,Oi,ki,Ai,ji,Mi,Ni,Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji,Yi,Xi,Zi,Qi=d(()=>{I(),z(),V(),Y(),si=(e,t,n,r,i,a,o)=>{let s=Math.ceil(t/4),c=``;c=typeof i==`string`?`${i}(a)`:i(`a`);let l=q(`inputData`,n,[s],4),u=J(`outputData`,r,[s],4),d=[{name:`vec_size`,type:`u32`}];return o&&d.push(...o),`
  ...
  }`},$=(e,t,n,r,i,a=e.dataType,o,s)=>{let c=[{type:12,data:Math.ceil(R.size(e.dims)/4)}];return o&&c.push(...o),{name:t,shaderCache:{hint:i,inputDependencies:[`type`]},getShaderSource:t=>si(t,R.size(e.dims),e.dataType,a,n,r,s),getRunData:t=>({outputs:[{dims:e.dims,dataType:a}],dispatchGroup:{x:Math.ceil(R.size(t[0].dims)/64/4)},programUniforms:c})}},ci=e=>{e.compute($(e.inputs[0],`Abs`,`abs`))},li=e=>{e.compute($(e.inputs[0],`Acos`,`acos`))},ui=e=>{e.compute($(e.inputs[0],`Acosh`,`acosh`))},di=e=>{e.compute($(e.inputs[0],`Asin`,`asin`))},fi=e=>{e.compute($(e.inputs[0],`Asinh`,`asinh`))},pi=e=>{e.compute($(e.inputs[0],`Atan`,`atan`))},mi=e=>{e.compute($(e.inputs[0],`Atanh`,`atanh`))},hi=e=>B(e),gi=(e,t)=>{let n;switch(t.to){case 10:n=`vec4<f16>`;break;case 1:n=`vec4<f32>`;break;case 12:n=`vec4<u32>`;break;case 6:n=`vec4<i32>`;break;case 9:n=`vec4<bool>`;break;default:throw RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute($(e.inputs[0],`Cast`,n,void 0,t.cacheKey,t.to))},_i=e=>{let t,n,r=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=i?e[2].getUint16Array()[0]:31743;break;default:throw Error(`Unsupport data type`)}return B({min:t,max:n})},vi=(e,t)=>{let n=t||_i(e.inputs),r=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`Clip`,e=>`clamp(${e}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:`min`,type:r},{name:`max`,type:r}]),{inputs:[0]})},yi=e=>{e.compute($(e.inputs[0],`Ceil`,`ceil`))},bi=e=>{e.compute($(e.inputs[0],`Cos`,`cos`))},xi=e=>{e.compute($(e.inputs[0],`Cosh`,`cosh`))},Si=e=>B(e),Ci=(e,t)=>{let n=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`Elu`,e=>`elu_vf32(${e})`,`
...
}`,Ti=e=>{let t=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`Erf`,e=>`erf_vf32(${e})`,wi(t)))},Ei=e=>{e.compute($(e.inputs[0],`Exp`,`exp`))},Di=e=>{e.compute($(e.inputs[0],`Floor`,`floor`))},Oi=e=>{let t=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`Gelu`,e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,wi(t)))},ki=(e,t)=>{let n=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`LeakyRelu`,e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},Ai=e=>{e.compute($(e.inputs[0],`Not`,e=>`!${e}`))},ji=e=>{e.compute($(e.inputs[0],`Neg`,e=>`-${e}`))},Mi=e=>{e.compute($(e.inputs[0],`Reciprocal`,e=>`1.0/${e}`))},Ni=e=>{let t=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`Relu`,e=>`select(vec4<${t}>(0.0), ${e}, ${e} > vec4<${t}>(0.0))`))},Pi=e=>{e.compute($(e.inputs[0],`Sigmoid`,e=>`(1.0 / (1.0 + exp(-${e})))`))},Fi=e=>B(e),Ii=(e,t)=>{let n=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`HardSigmoid`,e=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${e} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},Li=e=>{let t=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`HardSwish`,e=>`${e} * max(vec4<${t}>(0.0), min(vec4<${t}>(1.0), vec4<${t}>(${t}(1.0 / 6.0)) * ${e} + vec4<${t}>(0.5)))`))},Ri=e=>{e.compute($(e.inputs[0],`Sin`,`sin`))},zi=e=>{e.compute($(e.inputs[0],`Sinh`,`sinh`))},Bi=e=>{e.compute($(e.inputs[0],`Sqrt`,`sqrt`))},Vi=e=>{e.compute($(e.inputs[0],`Tan`,`tan`))},Hi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Ui=e=>{e.compute($(e.inputs[0],`Tanh`,Hi))},Wi=(e=`f32`)=>`
...
`,Gi=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ki=e=>{let t=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`FastGelu`,Gi,Wi(t),void 0,e.inputs[0].dataType))},qi=(e,t)=>{let n=U(e.inputs[0].dataType);return e.compute($(e.inputs[0],`ThresholdedRelu`,e=>`select(vec4<${n}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Ji=e=>{e.compute($(e.inputs[0],`Log`,`log`))},Yi=(e,t)=>`
...
`,Xi=e=>`quick_gelu_impl(${e})`,Zi=(e,t)=>{let n=U(e.inputs[0].dataType);e.compute($(e.inputs[0],`QuickGelu`,Xi,Yi(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),$i,ea,ta,na=d(()=>{z(),Y(),Qi(),$i=e=>{if(e[0].dims.length!==3)throw Error(`input should have 3 dimensions`);if(![2560,5120,10240].includes(e[0].dims[2]))throw Error(`hidden state should be 2560, 5120 or 10240`);if(e[1].dims.length!==1)throw Error(`bias is expected to have 1 dimensions`);if(e[0].dims[2]!==e[1].dims[0])throw Error(`last dimension of input and bias are not the same`)},ea=e=>{let t=e[0].dims.slice();t[2]/=2;let n=q(`input`,e[0].dataType,e[0].dims,4),r=q(`bias`,e[0].dataType,[e[0].dims[2]],4),i=J(`output`,e[0].dataType,t,4),a=R.size(t)/4,o=H(e[0].dataType);return{name:`BiasSplitGelu`,getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:t=>`
  ...
  ${t.mainStart()}
    ...
    ${i.setByOffset(`global_idx`,`valueLeft * geluRight`)}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${_}
      }`},ia=(e,t,n,r,i,a,o=n.dataType)=>{let s=n.dims.map(Number),c=r.dims.map(Number),l=!R.areEqual(s,c),u=s,d=R.size(s),f=!1,p=!1,m=[l];if(l){let e=Wt.calcShape(s,c,!1);if(!e)throw Error(`Can't perform binary op on the given tensors`);u=e.slice(),d=R.size(u);let t=R.size(s)===1,n=R.size(c)===1,r=s.length>0&&s[s.length-1]%4==0,i=c.length>0&&c[c.length-1]%4==0;m.push(t),m.push(n),m.push(r),m.push(i);let a=1;for(let e=1;e<u.length;e++){let t=s[s.length-e];if(t===c[c.length-e])a*=t;else break}a%4==0?(p=!0,f=!0):(t||n||r||i)&&(f=!0)}else f=!0;return m.push(f),{name:e,shaderCache:{hint:t+m.map(e=>e.toString()).join(`_`),inputDependencies:[`rank`,`rank`]},getShaderSource:e=>ra(e,s,c,u,f,l,p,i,n.dataType,r.dataType,o,a),getRunData:()=>({outputs:[{dims:u,dataType:o}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(R.size(u)/4)},...W(s,c,u)]})}},aa=(e,t,n,r,i,a)=>{e.compute(ia(t,i??``,e.inputs[0],e.inputs[1],n,r,a))},oa=e=>{aa(e,`Add`,(e,t)=>`${e}+${t}`)},sa=e=>{aa(e,`Div`,(e,t)=>`${e}/${t}`)},ca=e=>{aa(e,`Equal`,{scalar:(e,t)=>`u32(${e}==${t})`,vector:(e,t)=>`vec4<u32>(${e}==${t})`},void 0,void 0,9)},la=e=>{aa(e,`Mul`,(e,t)=>`${e}*${t}`)},ua=e=>{let t=q(`input`,e.inputs[0].dataType,e.inputs[0].dims).type.value;aa(e,`Pow`,{scalar:(e,t)=>`pow_custom(${e},${t})`,vector:(e,t)=>`pow_vector_custom(${e},${t})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},da=e=>{aa(e,`Sub`,(e,t)=>`${e}-${t}`)},fa=e=>{aa(e,`Greater`,{scalar:(e,t)=>`u32(${e}>${t})`,vector:(e,t)=>`vec4<u32>(${e}>${t})`},void 0,void 0,9)},pa=e=>{aa(e,`Less`,{scalar:(e,t)=>`u32(${e}<${t})`,vector:(e,t)=>`vec4<u32>(${e}<${t})`},void 0,void 0,9)},ma=e=>{aa(e,`GreaterOrEqual`,{scalar:(e,t)=>`u32(${e}>=${t})`,vector:(e,t)=>`vec4<u32>(${e}>=${t})`},void 0,void 0,9)},ha=e=>{aa(e,`LessOrEqual`,{scalar:(e,t)=>`u32(${e}<=${t})`,vector:(e,t)=>`vec4<u32>(${e}<=${t})`},void 0,void 0,9)}}),_a,va,ya,ba,xa,Sa,Ca=d(()=>{I(),z(),V(),Y(),_a=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);let n=e[0],r=n.dataType,i=n.dims.length;e.forEach((e,a)=>{if(a!==0){if(e.dataType!==r)throw Error(`input tensors should be one type`);if(e.dims.length!==i)throw Error(`input tensors should have the same shape`);e.dims.forEach((e,r)=>{if(r!==t&&e!==n.dims[r])throw Error(`non concat dimensions must match`)})}})},va=(e,t)=>`
...
`}),Pa,Fa,Ia=d(()=>{I(),z(),Y(),Oa(),Pa=(e,t,n,r,i)=>{let a=r-n;return`
...
`},Fa=(e,t,n,r,i=!1,a)=>{let o=e[0].dims,s=e[1].dims,c=o[o.length-2],l=s[s.length-1],u=o[o.length-1],d=G(l),f=G(u),p=G(c),m=R.size(n)/d/p,h=e.length>2,g=r?r.slice(0,-2):n.slice(0,-2),_=[R.size(g),c,l],v=[{type:12,data:m},{type:12,data:c},{type:12,data:l},{type:12,data:u}];return Ta(t,v),v.push(...W(g,o,s)),h&&v.push(...W(e[2].dims)),v.push(...W(_)),{name:`MatMulNaive`,shaderCache:{hint:`${t.activation};${d};${f};${p};${i}`,inputDependencies:h?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:v}),getShaderSource:r=>{let a=Nn(`batch_dims`,e[0].dataType,g.length),c=q(`a`,e[0].dataType,o.length,f),l=q(`b`,e[1].dataType,s.length,d),u=J(`output`,e[0].dataType,_.length,d),m=H(u.type.tensor),v=wa(t,u.type.value,m),y=[c,l],b=``;if(h){let t=i?d:1;y.push(q(`bias`,e[2].dataType,e[2].dims.length,t)),b=`${i?`value += bias[col / ${t}];`:`value += ${u.type.value}(bias[row + i]);`}`}let x=[{name:`output_size`,type:`u32`},{name:`M`,type:`u32`},{name:`N`,type:`u32`},{name:`K`,type:`u32`}];Ea(t,x);let S=()=>{let e=`var a_data: ${c.type.value};`;for(let t=0;t<f;t++)e+=`
...
`}return e};return`
  ...
  `}}}}),La,Ra,za,Ba,Va,Ha,Ua,Wa,Ga=d(()=>{I(),z(),Y(),Oa(),Ia(),ja(),La=(e,t)=>e?`
...
`},Ua=(e,t,n,r,i=!1)=>{let[a,o,s,c]=r,l=H(r[0].type.tensor);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${x}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${c}>`:c}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${c} {
          ...
          }`}}}}),io,ao,oo=d(()=>{I(),z(),Y(),Oa(),io=(e,t,n,r)=>{let i=e.length>2,a=i?`value += b[output_channel];`:``,o=e[0].dims,s=e[1].dims,c=t.format===`NHWC`,l=c?n[3]:n[1],u=l/t.group,d=c&&u>=4?G(l):1,f=R.size(n)/d,p=[{type:12,data:f},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:u}];Ta(t,p),p.push(...W(o,[s[0],s[1],s[2],s[3]/d]));let m=i?[`rank`,`rank`,`rank`]:[`rank`,`rank`];return p.push(...W([n[0],n[1],n[2],n[3]/d])),{name:`GroupedConv`,shaderCache:{hint:`${t.cacheKey}_${d}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:p}),getShaderSource:r=>{let l=J(`output`,e[0].dataType,n.length,d),u=H(l.type.tensor),f=wa(t,l.type.value,u),p=q(`x`,e[0].dataType,o.length),m=q(`w`,e[1].dataType,s.length,d),h=[p,m];i&&h.push(q(`b`,e[2].dataType,e[2].dims,d));let g=[{name:`output_size`,type:`u32`},{name:`dilations`,type:`u32`,length:t.dilations.length},{name:`strides`,type:`u32`,length:2},{name:`pads`,type:`u32`,length:2},{name:`output_channels_per_group`,type:`u32`}];Ea(t,g);let _=c?`
  ...
  ${n.mainStart()}
    ...
    ${x}}`}}}}),bo,xo,So,Co,wo,To,Eo,Do,Oo,ko=d(()=>{yo(),Oa(),Gn(),bo=(e,t,n,r,i,a)=>(e-1)*t+n+(r-1)*i+1-a,xo=(e,t,n,r,i)=>{let a=Math.floor(e/2);t===`SAME_UPPER`?(n[r]=a,n[i]=e-a):t===`SAME_LOWER`&&(n[r]=e-a,n[i]=a)},So=(e,t,n,r,i,a,o,s,c,l)=>{let u=e.length-2,d=l.length===0;c.length<u&&c.push(...Array(u-c.length).fill(0));let f=e[0],p=t[s?3:1]*i;for(let i=0,f=e.length-u-+!!s;i<u;++i,++f){let s=e[f],p=d?s*o[i]:l[i],m=bo(s,o[i],a[i],t[f],n[i],p);xo(m,r,a,i,i+u),d&&l.push(o[i]*(s-1)+c[i]+(t[f]-1)*n[i]+1-a[i]-a[i+u])}l.splice(0,0,f),l.splice(s?3:1,0,p)},Co=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((e,t)=>e*t,1)===0){n.length=0;for(let e=2;e<t[1].dims.length;++e)n.push(t[1].dims[e])}let r=e.format===`NHWC`;n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let i=e.pads.slice(),a=e.outputShape.slice(),o=e.outputPadding.slice(),s=t[0].dims,c=e.dilations.slice();if(c.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;c=Array(e).fill(1)}let l=e.strides.slice();if(l.reduce((e,t)=>e+t,0)===0){let e=t[0].dims.length-2;l=Array(e).fill(1)}So(s,n,c,e.autoPad,e.group,i,l,r,o,a);let u=Object.assign({},e);return Object.assign(u,{kernelShape:n,pads:i,outputPadding:o,outputShape:a,dilations:c,strides:l}),u},wo=e=>{let t=Da(e),n=e.format,r=[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][typeof e.autoPad>`u`?0:e.autoPad],i=e.dilations,a=e.group??1,o=e.kernelShape,s=e.pads,c=e.strides,l=e.wIsConst();return{autoPad:r,format:n,dilations:i,group:a,kernelShape:o,outputPadding:e.outputPadding,outputShape:e.outputShape,pads:s,strides:c,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},To=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw Error(`Conv requires 2 or 3 inputs`);if(e[0].dims.length!==4&&e[0].dims.length!==3)throw Error(`currently only support 2-dimensional conv`);if(e[0].dims.length!==e[1].dims.length)throw Error(`filter does not have same dimension as input`);if(e[0].dims[t.format===`NHWC`?e[0].dims.length-1:1]!==e[1].dims[0])throw Error(`FILTER_IN_CHANNEL should be equal to DATA_CHANNEL`);let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw Error(`invalid bias`);let r=e[0].dims.length-2;if(t.dilations.reduce((e,t)=>e+t,0)>0&&t.dilations.length!==r)throw Error(`dilations should be ${r}D`);if(t.strides.reduce((e,t)=>e+t,0)>0&&t.strides.length!==r)throw Error(`strides should be ${r}D`);if(t.pads.reduce((e,t)=>e+t,0)>0&&t.pads.length!==r*2)throw Error(`pads should be ${r*2}D`);if(t.outputPadding.length!==r&&t.outputPadding.length!==0)throw Error(`output_padding should be ${r}D`);if(t.kernelShape.reduce((e,t)=>e+t,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw Error(`invalid kernel shape`);if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw Error(`invalid output shape`)},Eo=(e,t,n,r)=>{let i=e.kernelCustomData.wT??e.compute(Hn(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let a=[t[0],i];t.length===3&&a.push(t[2]),e.compute(vo(a,n,r),{inputs:a})},Do=(e,t)=>{let n=t.format===`NHWC`,r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let o=t.strides;(o.length===0||o[0]===0)&&(o=[1]);let s=t.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],o=[1].concat(o),a=[1].concat(a),i=[1].concat(i);let c=t.outputPadding;c=[0].concat(c);let l=Co({...t,pads:s,strides:o,dilations:a,kernelShape:i,outputPadding:c},r);Eo(e,r,l,e=>n?[e[0],e[2],e[3]]:[e[0],e[1],e[3]])},Oo=(e,t)=>{if(To(e.inputs,t),e.inputs[0].dims.length===3)Do(e,t);else{let n=Co(t,e.inputs);Eo(e,e.inputs,n)}}}),Ao,jo,Mo,No=d(()=>{I(),z(),V(),Y(),Ao=(e,t,n,r)=>{let i=R.size(t),a=t.length,o=q(`input`,e,a),s=J(`output`,e,a),c=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=R.normalizeAxis(c,a);return{name:`CumSum`,shaderCache:{hint:r.cacheKey,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:l},...W(t,t)]}),getShaderSource:e=>{let t=` i32(${o.indicesGet(`inputIndices`,`uniforms.axis`)}) `,n=K(`uniforms.input_shape`,`uniforms.axis`,a),i=r.reverse?t+(r.exclusive?` + 1`:``):`0`,c=r.reverse?n:t+(r.exclusive?``:` + 1`);return`
                ...
                }`}}},jo=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,i=e.inputs[1];e.compute(Ao(r,n,i,t),{inputs:[0]})},Mo=e=>{let t=e.exclusive===1,n=e.reverse===1;return B({exclusive:t,reverse:n})}}),Po,Fo,Io,Lo,Ro,zo=d(()=>{I(),z(),V(),Y(),Po=e=>{if(!e||e.length!==1)throw Error(`DepthToSpace requires 1 input.`);if(e[0].dims.length!==4)throw Error(`DepthToSpace requires 4D input.`)},Fo=(e,t,n,r)=>{let i=[];i.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)},Io=(e,t)=>{let n,r,i,a,o,s,c=t.format===`NHWC`,l=t.blocksize,u=t.mode===`DCR`;c?([n,r,i,a]=e.dims,o=u?[n,r,i,l,l,a/l**2]:[n,r,i,a/l**2,l,l],s=u?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,r,i,a]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],o=u?[n,l,l,a/l**2,r,i]:[n,a/l**2,l,l,r,i],s=u?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let d=e.reshape(o),f=d.dims.length,p=e.dataType,m=q(`a`,p,f),h=J(`output`,p,f);return{name:`DepthToSpace`,shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:[`rank`]},getRunData:e=>{let t=c?[n,r*l,i*l,a/l**2]:[n,a/l**2,r*l,i*l],o=R.size(t),u=d.dims,f=R.sortBasedOnPerm(u,s);return{outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},...W(u,f)]}},getShaderSource:e=>`
  ...
  }`}},Lo=(e,t)=>{Po(e.inputs),e.compute(Io(e.inputs[0],t))},Ro=e=>B({blocksize:e.blocksize,mode:e.mode,format:e.format})}),Bo,Vo,Ho,Uo,Wo,Go,Ko,qo,Jo,Yo,Xo,Zo,Qo,$o,es,ts,ns,rs=d(()=>{I(),z(),V(),Y(),Bo=256,Vo=512,Ho=2*Math.PI,Uo=e=>{let t=[],n=e;for(let e of[4,2,3,5])for(;n%e===0;)t.push(e),n/=e;return n===1?t:void 0},Wo=e=>{let t=e.toPrecision(9);return/[.eE]/.test(t)?t:`${t}.0`},Go=(e,t,n,r,i)=>{let a=n/e,o=Vo-r,s=e=>`smem[${o}u + base + ${e*t}u]`,c=`  for (var t = local_idx; t < ${a}u; t += ${Bo}u) {
...
`;else{let r=i*Ho*n/(e*t);c+=`    { let a = ${Wo(r)} * angleUnit; leg[${n}] = cmul(smem[${o}], vec2<f32>(cos(a), sin(a))); }
...
`,c+=`    ${s(2)} = evenSum - oddSum;
    ${s(3)} = evenDiff - oddRot;
`}else for(let t=0;t<e;t++){let n=[`leg[0]`];for(let r=1;r<e;r++){let a=i*Ho*(r*t)/e,o=Wo(Math.cos(a)),s=Wo(Math.sin(a));n.push(`vec2<f32>(leg[${r}].x*${o} - leg[${r}].y*${s}, leg[${r}].x*${s} + leg[${r}].y*${o})`)}c+=`    ${s(t)} = ${n.join(` + `)};
`}return`${c}  }
  workgroupBarrier();
`},Ko=(e,t,n)=>{let r=``,i=1,a=0;for(let o of e)r+=Go(o,i,t,a,n),i*=o,a=Vo-a;return{code:r,resultOffset:a}},qo=(e,t,n,r,i)=>{let a=e.dims,o=a.length,s=a[o-1],c=a[t],l=n&&r?(c-1)*2:c;i!==void 0&&(l=i);let u=n&&r?1:2,d=r&&!n?Math.floor(l/2)+1:l,f=a.slice();f[t]=d,f[o-1]=u;let p=1;for(let e=t+1;e<o-1;e++)p*=a[e];let m=R.size(a)/s/c;return{dataType:e.dataType,outputDims:f,length:l,signalLength:c,inner:p,batch:m,inputComponents:s,outputComponents:u,outputLength:d,inverse:n,onesided:r}},Jo=(e,t)=>[t,e.length,e.inputComponents,e.outputComponents,e.inverse,e.onesided].join(`;`),Yo=e=>[{type:12,data:e.batch},{type:12,data:e.signalLength},{type:12,data:e.inner},{type:12,data:e.outputLength}],Xo=(e,t,n)=>e.registerUniform(`batch`,`u32`).registerUniform(`signalLength`,`u32`).registerUniform(`inner`,`u32`).registerUniform(`outputLength`,`u32`).declareVariables(t,n),Zo=e=>{let{dataType:t,length:n,inputComponents:r,outputComponents:i,inverse:a,onesided:o}=e,s=U(t),c=a?1:-1,l=a?1/n:1,u=Uo(n);return{name:`DFT`,shaderCache:{hint:Jo(e,`fft`),inputDependencies:[`type`]},getShaderSource:e=>{let d=q(`x`,t,[1]),f=J(`y`,t,[1]),p=e=>{let t=`inBase + (${e}) * uniforms.inner * ${r}u`;return`vec2<f32>(${`f32(${d.getByOffset(t)})`}, ${r===2?`f32(${d.getByOffset(`${t} + 1u`)})`:`0.0`})`},m;if(a&&o){let e=Math.floor(n/2)+1,t=n%2==0?`select(provided, provided - 1u, provided == ${e}u)`:`provided`;m=`
    let provided = min(uniforms.signalLength, ${e}u);
    for (var i = local_idx; i < ${n}u; i += ${Bo}u) {
      if (i < provided) { smem[i] = ${p(`i`)}; } else { smem[i] = vec2<f32>(0.0); }
    }
    workgroupBarrier();
    for (var k = local_idx + 1u; k < ${t}; k += ${Bo}u) {
      let h = smem[k];
    ...
    workgroupBarrier();`;let{code:h,resultOffset:g}=Ko(u,n,c),_=l===1?`smem[${g}u + i]`:`smem[${g}u + i] * ${Wo(l)}`,v=i===2?f.setByOffset(`off + 1u`,`${s}(v.y)`):``;return`
  ${Xo(e,d,f)}
  var<workgroup> smem: array<vec2<f32>, ${2*Vo}>;
  ...
  ${e.mainStart(Bo)}
    ...
    ${m}
${h}    for (var i = local_idx; i < uniforms.outputLength; i += ${Bo}u) {
      let v = ${_};
      let off = outBase + i * uniforms.inner * ${i}u;
      ${f.setByOffset(`off`,`${s}(v.x)`)}
      ${v}
    }
  }`},getRunData:()=>({outputs:[{dims:e.outputDims,dataType:t}],programUniforms:Yo(e),dispatchGroup:{x:e.batch}})}},Qo=e=>{let{dataType:t,length:n,inputComponents:r,outputComponents:i,inverse:a,onesided:o}=e,s=U(t),c=a?1:-1,l=a?1/n:1;return{name:`DFT`,shaderCache:{hint:Jo(e,`direct`),inputDependencies:[`type`]},getShaderSource:e=>{let u=q(`x`,t,[1]),d=J(`y`,t,[1]),f=e=>{let t=`inBase + (${e}) * uniforms.inner * ${r}u`;return`vec2<f32>(${`f32(${u.getByOffset(t)})`}, ${r===2?`f32(${u.getByOffset(`${t} + 1u`)})`:`0.0`})`},p=a&&o?`fn spectrum(inBase: u32, k: u32) -> vec2<f32> {
    ...
    return vec2<f32>(0.0, 0.0);
      ...
      let angle = ${Wo(c*Ho)} * f32(knMod) / ${Wo(n)};
      acc += cmul(spectrum(inBase, n), vec2<f32>(cos(angle), sin(angle)));
      knMod += k;
      if (knMod >= ${n}u) { knMod -= ${n}u; }`,h=i===2?d.setByOffset(`off + 1u`,`${s}(v.y)`):``,g=l===1?`acc`:`acc * ${Wo(l)}`;return`
  ${Xo(e,u,d)}
  fn cmul(a: vec2<f32>, b: vec2<f32>) -> vec2<f32> {
    return vec2<f32>(a.x * b.x - a.y * b.y, a.x * b.y + a.y * b.x);
  }
  ...
  ${e.mainStart(Bo)}
    ...
    let inBase = (outer * uniforms.signalLength * uniforms.inner + within) * ${r}u;
    let outBase = (outer * uniforms.outputLength * uniforms.inner + within) * ${i}u;
    for (var k = local_idx; k < uniforms.outputLength; k += ${Bo}u) {
  ...
  }`},getRunData:()=>({outputs:[{dims:e.outputDims,dataType:t}],programUniforms:Yo(e),dispatchGroup:{x:e.batch}})}},$o=e=>{if(!e||e.dataType===0)return;if(R.size(e.dims)!==1)throw Error(`DFT optional scalar inputs must have exactly 1 element.`);if(e.dataType===6)return e.getInt32Array()[0];let t=Number(e.getBigInt64Array()[0]);if(!Number.isSafeInteger(t))throw Error(`DFT optional scalar inputs are out of JavaScript safe integer range.`);return t},es=e=>{if(!e||e.length<1)throw Error(`DFT requires at least 1 input.`);let t=e[0].dims;if(t.length<2)throw Error(`DFT input must have at least 2 dimensions.`);let n=t[t.length-1];if(n!==1&&n!==2)throw Error(`DFT input's innermost dimension must be 1 (real) or 2 (complex).`)},ts=(e,t)=>{es(e.inputs);let n=e.inputs[0],r=n.dims.length,i=t.inverse!==0,a=t.onesided!==0,o=$o(e.inputs[1]);if(o!==void 0&&o<=0)throw Error(`dft_length must be greater than zero.`);let s=R.normalizeAxis($o(e.inputs[2])??t.axis,r);if(s===r-1)throw Error(`DFT axis must refer to a signal dimension, not the innermost (real/imaginary) dimension.`);if(i&&a&&n.dims[r-1]!==2)throw Error(`Inverse one-sided DFT (IRFFT) requires complex-valued input (innermost dimension 2).`);let c=qo(n,s,i,a,o);if(c.length<=0)throw Error(`Invalid DFT length: ${c.length}`);let l=c.length<=Vo&&Uo(c.length)!==void 0?Zo(c):Qo(c);e.compute(l,{inputs:[0]})},ns=e=>B({axis:e.axis??1,inverse:e.inverse??0,onesided:e.onesided??0})}),is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs=d(()=>{I(),z(),V(),Y(),is=`[a-zA-Z]|\\.\\.\\.`,as=`(`+is+`)+`,os=`^`+as+`$`,ss=`(`+as+`,)*`+as,cs=`^`+ss+`$`,ls=class{constructor(e=-1){this.symbolToIndices=new Map,this.inputIndex=e}addSymbol(e,t){let n=this.symbolToIndices.get(e);n===void 0?n=[t]:n.push(t),this.symbolToIndices.set(e,n)}},us=class{constructor(e,t){this.equation=t,this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=[],this.outputDims=[];let[n,r]=t.includes(`->`)?t.split(`->`,2):[t,``];if(!n.match(RegExp(cs)))throw Error(`Invalid LHS term`);if(n.split(`,`).forEach((t,n)=>{let r=e[n].dims.slice();if(!t.match(RegExp(os)))throw Error(`Invalid LHS term`);let i=this.processTerm(t,!0,r,n);this.lhs.push(i)}),r===``)r+=[...this.symbolToInfo.entries()].filter(([e,t])=>t.count===1||e===`...`).map(([e])=>e).join(``);else if(!r.match(RegExp(as)))throw Error(`Invalid RHS`);r.match(RegExp(is,`g`))?.forEach(e=>{if(e===`...`)this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let t=this.symbolToInfo.get(e);if(t===void 0)throw Error(`Invalid RHS symbol`);this.outputDims.push(t.dimValue)}}),this.rhs=this.processTerm(r,!1,this.outputDims)}addSymbol(e,t,n){let r=this.symbolToInfo.get(e);if(r!==void 0){if(r.dimValue!==t&&r.count!==1)throw Error(`Dimension mismatch`);r.count++,r.inputIndices.push(n)}else r={count:1,dimValue:t,inputIndices:[n]};this.symbolToInfo.set(e,r)}processTerm(e,t,n,r=-1){let i=n.length,a=!1,o=[],s=0;if(!e.match(RegExp(os))&&!t&&e!==``)throw Error(`Invalid LHS term`);let c=e.match(RegExp(is,`g`)),l=new ls(r);return c?.forEach((e,u)=>{if(e===`...`){if(a)throw Error(`Only one ellipsis is allowed per input term`);a=!0;let e=i-c.length+1;if(e<0)throw Error(`Ellipsis out of bounds`);if(o=n.slice(s,s+e),this.hasEllipsis){if(this.ellipsisDims.length!==o.length||this.ellipsisDims.toString()!==o.toString())throw Error(`Ellipsis dimensions mismatch`)}else if(t)this.hasEllipsis=!0,this.ellipsisDims=o;else throw Error(`Ellipsis must be specified in the LHS`);for(let e=0;e<o.length;e++){let t=String.fromCharCode(48+e);l.addSymbol(t,u+e),this.addSymbol(t,n[s++],r)}}else l.addSymbol(e,u+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(e,n[s++],r)}),l}},ds=e=>e+`_max`,fs=(e,t,n,r)=>{let i=e.map(e=>e.length).map((e,n)=>q(`input${n}`,t,e)),a=R.size(r),o=J(`output`,t,r.length),s=[...n.symbolToInfo.keys()].filter(e=>!n.rhs.symbolToIndices.has(e));return{name:`Einsum`,shaderCache:{hint:n.equation,inputDependencies:e.map(()=>`rank`)},getRunData:()=>{let i=s.filter(e=>n.symbolToInfo.has(e)).map(e=>({type:12,data:n.symbolToInfo.get(e)?.dimValue||0}));i.push({type:12,data:a});let o=e.map((e,t)=>[...W(e)]).reduce((e,t)=>e.concat(t),i);return o.push(...W(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:o}},getShaderSource:e=>{let t=[],r=[],a=[],c=[],l=[],u=n.symbolToInfo.size===n.rhs.symbolToIndices.size;n.symbolToInfo.forEach((e,s)=>{if(n.rhs.symbolToIndices.has(s)){let r=n.rhs.symbolToIndices.get(s)?.[0];r!==void 0&&n.lhs.forEach((n,a)=>{if(e.inputIndices.includes(a)){let e=n.symbolToIndices.get(s);if(e===void 0)throw Error(`Invalid symbol error`);e.forEach(e=>{t.push(`${i[a].indicesSet(`input${a}Indices`,e,o.indicesGet(`outputIndices`,r))}`)})}})}else n.lhs.forEach((t,n)=>{if(e.inputIndices.includes(n)){let e=t.symbolToIndices.get(s);if(e===void 0)throw Error(`Invalid symbol error`);e.forEach(e=>{r.push(`${i[n].indicesSet(`input${n}Indices`,e,`${s}`)}`)}),l.push(`prod *= ${i[n].getByIndices(`input${n}Indices`)};`)}}),a.push(`for(var ${s}: u32 = 0; ${s} < uniforms.${ds(s)}; ${s}++) {`),c.push(`}`)});let d=u?[...t,`let sum = ${i.map((e,t)=>e.getByIndices(`input${t}Indices`)).join(` * `)};`]:[...t,`var sum = 0.0;`,...a,...r,`var prod = 1.0;`,...l,`sum += prod;`,...c];return`
            ${e.registerUniforms(s.map(e=>({name:`${ds(e)}`,type:`u32`}))).registerUniform(`outputSize`,`u32`).declareVariables(...i,o)}
...
`)};
          ...
          }`}}},ps=(e,t)=>{let n=new us(e.inputs,t.equation),r=n.outputDims,i=e.inputs.map((e,t)=>e.dims);e.compute(fs(i,e.inputs[0].dataType,n,r))},ms=e=>{let t=e.equation.replace(/\s+/g,``);return B({equation:t})}}),gs,_s,vs,ys,bs,xs=d(()=>{I(),z(),Y(),gs=e=>{if(!e||e.length!==2)throw Error(`Expand requires 2 input.`);let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,i=t.length<n.length?0:t.length-n.length;for(;r<n.length&&i<t.length;++r,++i)if(n[r]!==t[i]&&n[r]!==1&&t[i]!==1)throw Error(`Expand requires shape to be broadcastable to input`)},_s=(e,t)=>{let n=e.length-t.length,r=[];for(let t=0;t<n;++t)r.push(e[t]);for(let i=0;i<t.length;++i)r.push(t[i]===1?e[i+n]:t[i]);return r},vs=(e,t)=>e.length>t.length?_s(e,t):_s(t,e),ys=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=vs(t,n),i=e[0].dataType,a=i===9||R.size(t)===1,o=i===9||t.length>0&&t[t.length-1]%4==0?4:1,s=a||r.length>0&&r[r.length-1]%4==0?4:1,c=Math.ceil(R.size(r)/s),l=e=>{let n=q(`input`,i,t.length,o),a=J(`output`,i,r.length,s),c;if(i===9){let e=(e,t,r=``)=>`
    ...
    ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
    ${c}`},u=[{type:12,data:c},...W(t,r)];return{name:`Expand`,shaderCache:{hint:`${r.length};${o}${s}`,inputDependencies:[`rank`]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:u})}},bs=e=>{gs(e.inputs),e.compute(ys(e.inputs),{inputs:[0]})}}),Ss,Cs,ws=d(()=>{I(),z(),Y(),Qi(),Ss=e=>{let t=e[0].dataType,n=R.size(e[0].dims),r=R.size(e[1].dims),i=r%4==0;return{name:`FastGeluWithBias`,shaderCache:{hint:`${i}`,inputDependencies:[`type`,`type`]},getShaderSource:e=>{let n=q(`x`,t,[1],4),r=q(`bias`,t,[1],4),a=J(`y`,t,[1],4),o=[{name:`output_vec_size`,type:`u32`},{name:`bias_size`,type:`u32`}],s=e=>`
  ...
  ${e.mainStart()}
    ...
    }`}}},Is=(e,t)=>{let n=e.inputs;Ps(n,t),e.compute(Fs(e.inputs,t))},Ls=e=>B({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),zs,Bs,Vs,Hs,Us=d(()=>{I(),z(),V(),Y(),zs=e=>{if(!e||e.length!==2)throw Error(`GatherElements requires 2 inputs.`);if(e[0].dims.length<1)throw Error(`GatherElements requires that the data input be rank >= 1.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`GatherElements requires that the data input and
  ...
  }`}}},Ks=e=>({transA:e.transA,transB:e.transB,alpha:e.alpha,beta:e.beta,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}),qs=(e,t)=>{Ws(e.inputs),e.compute(Gs(e.inputs,t))}}),Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,oc,sc,cc,lc=d(()=>{I(),z(),V(),Y(),[Ys,Xs,Zs,Qs]=[0,1,2,3],$s=e=>{if(e[0].dims.length!==4)throw Error(`only 4-D tensor is supported.`);if(e[0].dims.length!==e[1].dims.length)throw Error(`input dimensions must be equal to grid dimensions`);if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error(`grid batch size must match input batch size`)},ec=`
...
`,ac=(e,t,n)=>(()=>{switch(n.mode){case`nearest`:return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Ys}], indices[${Xs}], border);
        `;case`bilinear`:return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Ys}], indices[${Xs}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Ys}], indices[${Xs}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Ys}], indices[${Xs}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Ys}], indices[${Xs}], border);
        ...
        `;case`bicubic`:return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Ys}], indices[${Xs}], border);
            }
          }
  ...
  }`}},{inputs:[t,n],outputs:[-1]})[0]},hc=(e,t,n,r,i,a,o,s)=>{let c=a;if(o&&R.size(o.dims)>0){if(r===1)throw Error(`AddBiasReshape is not implemented. Please export your model with packed QKV or KV`);return c=mc(e,a,o,t,r,n*i,s),c=c.reshape([t,r,n,i]),n===1||r===1?c:e.compute(Hn(c,pc.perm),{inputs:[c],outputs:[-1]})[0]}return a.dims.length===3&&(c=a.reshape([t,r,n,i])),n===1||r===1?c:e.compute(Hn(c,pc.perm),{inputs:[c],outputs:[-1]})[0]},gc=(e,t)=>{let n=dc(e.inputs,t),r=e.inputs[0],i=uc(e.inputs,1),a=uc(e.inputs,2),o=uc(e.inputs,3),s=uc(e.inputs,4),c=uc(e.inputs,5),l=uc(e.inputs,6),u=uc(e.inputs,7);if(r.dims.length===5)throw Error(`Packed QKV is not implemented`);if(i?.dims.length===5)throw Error(`Packed KV is not implemented`);let d=i&&a&&i.dims.length===4&&a.dims.length===4,f=hc(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,o,0);if(d)return Jr(e,f,i,a,s,void 0,l,u,c,n);if(!i||!a)throw Error(`key and value must be provided`);let p=hc(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,i,o,n.hiddenSize),m=hc(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,o,2*n.hiddenSize);Jr(e,f,p,m,s,void 0,l,u,c,n)}}),vc,yc,bc,xc,Sc,Cc,wc,Tc=d(()=>{I(),z(),V(),Y(),vc=e=>{if(!e||e.length<1)throw Error(`too few inputs`)},yc=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(e=>n.push(Number(e))),r=n.length),B({numOutputs:r,axis:t.axis,splitSizes:n})},bc=e=>`
...
`)}
  ...
  `}}},Pc=(e,t)=>{if(e.inputs.length>14&&e.inputs[14]||e.inputs.length>15&&e.inputs[15])throw Error(`GroupQueryAttention (JSEP): q_norm_weight / k_norm_weight inputs are not supported. The per-head Q/K RMS normalization prologue is implemented only on the CUDA and native WebGPU EPs.`);let n=Ac(e.inputs,t);if(e.inputs[0].dims.length===5)throw Error(`Packed QKV is not implemented`);if(e.inputs[1]?.dims.length===5)throw Error(`Packed KV is not implemented`);let r=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,a=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,s=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,c=e.inputs.length>4?e.inputs[5]:void 0,l=e.inputs.length>5?e.inputs[6]:void 0,u=n.kvNumHeads?n.kvNumHeads:n.numHeads,d=B({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,u*n.headSize,u*n.headSize]}),[f,p,m]=!i&&!a?e.compute(Sc([r],d),{inputs:[r],outputs:[-1,-1,-1]}):[r,i,a],h,g;if(t.doRotary){let r=e.compute(Nc(n.batchSize,n.sequenceLength,c,l),{inputs:[c,l],outputs:[-1]})[0],i=e.inputs[7],a=e.inputs[8],o=B({interleaved:t.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),s=[f,r,i,a],u=[-1];h=e.compute(Dc(s,o),{inputs:s,outputs:u})[0],s.splice(0,1,p);let d=B({interleaved:t.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});g=e.compute(Dc(s,d),{inputs:s,outputs:u})[0]}let _=hc(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t.doRotary?h:f,void 0,0),v=Mc(e,t.doRotary?g:p,n),y=Mc(e,m,n);Jr(e,_,v,y,void 0,void 0,o,s,void 0,n,c,l)}}),Ic,Lc,Rc,zc,Bc=d(()=>{I(),z(),Gn(),Y(),Ic=(e,t,n,r,i,a,o,s)=>{let c=G(a),l=c===1?`f32`:`vec${c}f`,u=c===1?`vec2f`:`mat2x${c}f`,d=i*o,f=64;d===1&&(f=256);let p=[i,o,a/c],m=[i,o,2],h=[`rank`,`type`,`type`],g=[];return g.push(...W(p,m)),e.compute({name:`InstanceNormComputeChannelScaleShift`,shaderCache:{hint:`${c};${s};${f}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:d},programUniforms:g}),getShaderSource:e=>{let i=q(`x`,t.dataType,3,c),a=[i,q(`scale`,n.dataType,n.dims),q(`bias`,r.dataType,r.dims),J(`output`,1,3,2)];return`
  ...
  }`}},{inputs:[t,n,r],outputs:[-1]})[0]},Lc=(e,t,n)=>{let r=t[0].dims,i=r,a=r[0],o=r[1],s=R.sizeFromDimension(r,2),c=G(s),l=R.size(i)/c,u=Ic(e,t[0],t[1],t[2],a,s,o,n.epsilon),d=[a,o,s/c],f=[a,o];e.compute({name:`InstanceNormalization`,shaderCache:{hint:`${c}`,inputDependencies:[`type`,`none`]},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:[{type:12,data:l},...W(d,f,d)]}),getShaderSource:e=>{let n=q(`x`,t[0].dataType,d.length,c),r=q(`scale_shift`,1,f.length,2),i=J(`output`,t[0].dataType,d.length,c),a=[n,r,i];return`
  ...
  }`}},{inputs:[t[0],h]})},zc=(e,t)=>{t.format===`NHWC`?Rc(e,e.inputs,t):Lc(e,e.inputs,t)}}),Vc,Hc,Uc,Wc=d(()=>{I(),z(),Y(),Vc=e=>{if(!e||e.length<2)throw Error(`layerNorm requires at least 2 inputs.`)},Hc=(e,t,n)=>{let r=t.simplified,i=e[0].dims,a=e[1],o=!r&&e[2],s=i,c=R.normalizeAxis(t.axis,i.length),l=R.sizeToDimension(i,c),u=R.sizeFromDimension(i,c),d=R.size(a.dims),f=o?R.size(o.dims):0;if(d!==u||o&&f!==u)throw Error(`Size of X.shape()[axis:] == ${u}.
  ...
  ${t.mainStart()}
    ...
    ${v?`inv_std_output[global_idx] = inv_std_dev`:``};
  }`},b=[{dims:s,dataType:e[0].dataType}];return _&&b.push({dims:p,dataType:1}),v&&b.push({dims:p,dataType:1}),{name:`LayerNormalization`,shaderCache:{hint:`${m};${n};${r}`,inputDependencies:h},getRunData:()=>({outputs:b,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:g}),getShaderSource:y}},Uc=(e,t)=>{Vc(e.inputs),e.compute(Hc(e.inputs,t,e.outputCount))}}),Gc,Kc,qc=d(()=>{z(),Ia(),Ga(),Gc=e=>{if(!e||e.length!==2)throw Error(`MatMul requires 2 inputs.`);if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw Error(`shared dimension does not match.`)},Kc=e=>{Gc(e.inputs);let t=Wt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw Error(`Can't use matmul on the given tensors`);let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(Fa(e.inputs,{activation:``},t));else{let i=t[t.length-2],a=R.size(e.inputs[0].dims.slice(0,-2)),o=R.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&i===1&&o===1){let i=e.inputs[0].reshape([1,a,r]),o=e.inputs[1].reshape([1,r,n]),s=[1,a,n],c=[i,o];e.compute(Wa(c,{activation:``},t,s),{inputs:c})}else e.compute(Wa(e.inputs,{activation:``},t))}}}),Jc,Yc,Xc,Zc,Qc,$c=d(()=>{I(),z(),V(),Y(),Jc=(e,t)=>{if(e.length<3||e.length>4)throw Error(`MatMulNBits requires 3 or 4 inputs`);let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw Error(`The last dim of input shape does not match the k value`);let i=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,o=e[1];if(!R.areEqual(o.dims,[t.n,i,a]))throw Error(`The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize`);let s=e[2].dims;if(R.size(s)!==t.n*i)throw Error(`scales input size error.`);if(e.length===4){let n=e[3].dims,r=t.n*(t.bits===8?i:Math.floor((i*t.bits+7)/8));if(R.size(n)!==r)throw Error(`zeroPoints input size error.`)}},Yc=(e,t)=>{let n=e[0].dims,r=n.length,i=n[r-2],a=t.k,o=t.n,s=n.slice(0,r-2),c=R.size(s),l=e[1].dims[2]/4,u=e[0].dataType,d=G(t.k),f=G(l),p=G(o),m=s.concat([i,o]),h=i>1&&o/p%2==0?2:1,g=R.size(m)/p/h,_=[],v=[c,i,a/d],y=R.convertShape(e[1].dims).slice();y.splice(-1,1,l/f),_.push(...W(v)),_.push(...W(y)),_.push(...W(e[2].dims)),e.length===4&&_.push(...W(R.convertShape(e[3].dims)));let b=[c,i,o/p];return _.push(...W(b)),{name:`MatMulNBits`,shaderCache:{hint:`${t.blockSize};${t.bits};${d};${f};${p};${h};64`,inputDependencies:Array(e.length).fill(`rank`)},getRunData:()=>({outputs:[{dims:m,dataType:u}],dispatchGroup:{x:g},programUniforms:_}),getShaderSource:n=>{let r=v.length,i=q(`a`,e[0].dataType,r,d),a=q(`b`,12,y.length,f),o=q(`scales`,e[2].dataType,e[2].dims.length),s=[i,a,o],c=e.length===4?q(`zero_points`,12,e[3].dims.length):void 0;c&&s.push(c);let u=b.length,m=J(`output`,e[0].dataType,u,p),g=H(e[0].dataType),_=(()=>{switch(d){case 1:return`array<${g}, 8>`;case 2:return`mat4x2<${g}>`;case 4:return`mat2x4<${g}>`;default:throw Error(`${d}-component is not supported.`)}})(),x=Math.floor(32/t.bits),S=Math.floor(x/8),C=()=>{let e=``;for(let n=0;n<S;n++){let r=n*t.bits*4,a=r+t.bits;e+=`
          // reuse a data (pass ${n})
        ...
        }`}}},Zc=(e,t)=>{Jc(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor(`intel`)&&e.adapterInfo.isArchitecture(`gen-12lp`)?e.compute(Xc(e.inputs,t)):e.compute(Yc(e.inputs,t))},Qc=e=>B(e)}),el,tl,nl,rl,il,al,ol,sl,cl,ll=d(()=>{I(),z(),Y(),el=e=>{if(!e||e.length<1)throw Error(`Too few inputs`);if(e[0].dataType!==1&&e[0].dataType!==10)throw Error(`Input type must be float or float16.`);if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw Error(`The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].`)}},tl=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
      ...
      `},nl=(e,t,n)=>{let r=``;for(let i=t-1;i>=0;--i)r+=`
          ...
          `},al=(e,t,n)=>{switch(n.mode){case 0:return tl(e,t,n.pads.length);case 1:return nl(e,t,n.pads.length);case 2:return rl(e,t,n.pads.length);case 3:return il(e,t,n.pads.length);default:throw Error(`Invalid mode`)}},ol=(e,t)=>{let n=R.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,i=[{type:12,data:R.size(n)},{type:6,data:t.pads}],a=e.length>=3&&e[2].data;return t.mode===0&&i.push({type:a?e[2].dataType:1,data:t.value}),i.push(...W(e[0].dims,n)),{name:`Pad`,shaderCache:{hint:`${t.mode}${a}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(R.size(n)/64)},programUniforms:i}),getShaderSource:i=>{let o=J(`output`,e[0].dataType,n.length),s=q(`x`,e[0].dataType,r.length),c=s.type.value,l=al(o,r.length,t),u=[{name:`output_size`,type:`u32`},{name:`pads`,type:`i32`,length:t.pads.length}];return t.mode===0&&u.push({name:`constant_value`,type:a?c:`f32`}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},ml=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,hl=e=>`${ml(e)};${e.countIncludePad}`,gl=e=>`${ml(e)};${e.storageOrder};${e.dilations}`,_l=e=>({format:e.format,autoPad:[`NOTSET`,`VALID`,`SAME_UPPER`,`SAME_LOWER`][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),vl=(e,t,n,r)=>{let[i,a]=dl(t,r,n),o=q(`x`,t.dataType,t.dims.length),s=o.type.value,c=``;i.countIncludePad?c+=`value /= ${s}(uniforms.kernelSize);`:c+=`value /= ${s}(i32(uniforms.kernelSize) - pad);`;let[l,u,d,f,p]=fl(a,i);return l.push(...W(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${d};${f};${p}`,inputDependencies:[`rank`]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(R.size(a)/64)},programUniforms:l}),getShaderSource:e=>pl(e,o,t.dims.length,a.length,i,`value += x_val;`,c,0,u,d,f,p)}},yl=e=>{let t=e.count_include_pad!==0,n=_l(e);if(n.ceilMode!==0)throw Error(`ceil_mode output-shape is computed, but ceil_mode kernel execution (padding/divisor) is not yet implemented in the WebGPU AveragePool kernel`);let r={countIncludePad:t,...n,cacheKey:``};return{...r,cacheKey:hl(r)}},bl=(e,t)=>{ul(e.inputs),e.compute(vl(`AveragePool`,e.inputs[0],!1,t))},xl={autoPad:``,ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Sl=e=>{let t=e.format;return{format:t,...xl,cacheKey:t}},Cl=(e,t)=>{ul(e.inputs),e.compute(vl(`GlobalAveragePool`,e.inputs[0],!0,t))},wl=(e,t,n,r)=>{let[i,a]=dl(t,r,n),o=q(`x`,t.dataType,t.dims.length),s=[`rank`],[c,l,u,d,f]=fl(a,i);return c.push(...W(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${u};${d};${f}`,inputDependencies:s},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(R.size(a)/64)},programUniforms:c}),getShaderSource:e=>pl(e,o,t.dims.length,a.length,i,`
      value = max(x_val, value);
    `,``,t.dataType===10?-65504:-1e5,l,u,d,f)}},Tl=(e,t)=>{ul(e.inputs),e.compute(wl(`MaxPool`,e.inputs[0],!1,t))},El=e=>{let t=e.storage_order,n=e.dilations,r=_l(e);if(t!==0)throw Error(`column major storage order is not yet supported for MaxPool`);if(r.ceilMode!==0)throw Error(`ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel`);let i={storageOrder:t,dilations:n,...r,cacheKey:``};return{...i,cacheKey:gl(i)}},Dl=e=>{let t=e.format;return{format:t,...xl,cacheKey:t}},Ol=(e,t)=>{ul(e.inputs),e.compute(wl(`GlobalMaxPool`,e.inputs[0],!0,t))}}),Al,jl,Ml,Nl,Pl=d(()=>{I(),z(),V(),Y(),Al=(e,t)=>{if(e.length<2||e.length>3)throw Error(`DequantizeLinear requires 2 or 3 inputs.`);if(e.length===3&&e[1].dims===e[2].dims)throw Error(`x-scale and x-zero-point must have the same shape.`);if(e.length===3&&e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw Error(`scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.`);if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error(`x and x-zero-point must have the same data type.`);if(e[1].dims.length!==e[2].dims.length)throw Error(`scale and zero-point inputs must have the same rank.`);if(!e[1].dims.map((t,n)=>t===e[2].dims[n]).reduce((e,t)=>e&&t,!0))throw Error(`scale and zero-point inputs must have the same shape.`)}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw Error(`blockSize must be set only for block quantization.`);if(!e[1].dims.map((n,r)=>r===t.axis||n===e[0].dims[r]).reduce((e,t)=>e&&t,!0))throw Error(`For block qunatization, scale input shape to match the input shape except for the axis`);if(e[1].dims.length!==e[0].dims.length)throw Error(`For block qunatization the scale input rank must be the same as the x rank.`);let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw Error(`blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].`)}},jl=(e,t)=>{let n=R.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,i=r===3,a=e[0].dims,o=e[1].dataType,s=R.size(a),c=r===3||r===2,l=c?[Math.ceil(R.size(e[0].dims)/4)]:e[0].dims,u=e[1].dims,d=e.length>2?e[2]:void 0,f=d?c?[Math.ceil(R.size(d.dims)/4)]:d.dims:void 0,p=u.length===0||u.length===1&&u[0]===1,m=p===!1&&u.length===1,h=G(s),g=p&&(!c||h===4),_=g?h:1,v=g&&!c?h:1,y=q(`input`,c?12:r,l.length,v),b=q(`scale`,o,u.length),x=d?q(`zero_point`,c?12:r,f.length):void 0,S=J(`output`,o,a.length,_),C=[y,b];x&&C.push(x);let w=[l,u];d&&w.push(f);let T=[{type:12,data:s/_},{type:12,data:n},{type:12,data:t.blockSize},...W(...w,a)];return{name:`DequantizeLinear`,shaderCache:{hint:t.cacheKey,inputDependencies:x?[`rank`,`rank`,`rank`]:[`rank`,`rank`]},getShaderSource:e=>`
      ...
      }`,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/_/64),y:1,z:1},programUniforms:T})}},Ml=(e,t)=>{Al(e.inputs,t),e.compute(jl(e.inputs,t))},Nl=e=>B({axis:e.axis,blockSize:e.blockSize})}),Fl,Il,Ll,Rl=d(()=>{Ne(),I(),Y(),Fl=(e,t,n)=>{if(e===t||e<t&&n<0||e>t&&n>0)throw Error(`Range these inputs' contents are invalid.`)},Il=(e,t,n,r)=>{let i=Math.abs(Math.ceil((t-e)/n)),a=[i],o=i,s=[{type:12,data:o},{type:r,data:e},{type:r,data:n},...W(a)];return{name:`Range`,shaderCache:{hint:`${r}`},getShaderSource:e=>{let t=J(`output`,r,a.length),n=t.type.value,i=[{name:`outputSize`,type:`u32`},{name:`start`,type:n},{name:`delta`,type:n}];return`
        ${e.registerUniforms(i).declareVariables(t)}
        ${e.mainStart()}
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.outputSize`)}
        output[global_idx] = uniforms.start + ${n}(global_idx) * uniforms.delta;
      }`},getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:s})}},Ll=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),D.webgpu.validateInputContent&&Fl(t,n,r),e.compute(Il(t,n,r,e.inputs[0].dataType),{inputs:[]})}}),zl,Bl,Vl,Hl,Ul=d(()=>{I(),z(),V(),Y(),zl=(e,t,n,r)=>{if(e!==`none`&&r!==`i32`&&r!==`u32`&&r!==`f32`)throw Error(`Input ${r} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${zl(t.reduction,`output[data_offset + i]`,`value`,o.type.value)}
  }

      }`}}},Vl=e=>B({reduction:e.reduction}),Hl=(e,t)=>{e.compute(Bl(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,$l,eu,tu,nu,ru,iu,au,ou,su,cu,lu,uu=d(()=>{I(),z(),V(),Y(),Wl=(e,t)=>{if(e.every(e=>e>0||(()=>{throw Error(`Resize requires scales input values to be positive`)})),e.length>0){if(t.mode===`linear`){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode===`cubic`&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw Error(`Resize requires scales input size to be 2 or 4 for cubic mode`)}},Gl=(e,t,n)=>{t.every(e=>e>=0&&e<n||(()=>{throw Error(`Resize requires axes input values to be positive and less than rank`)}));let r=Array(n).fill(1);return t.forEach((t,n)=>r[t]=e[n]),r},Kl=(e,t,n,r,i,a)=>{let[o,s,c]=n>10?[1,2,3]:[-1,e.length>1?1:-1,-1],l=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(e=>a.push(e));else if(t.coordinateTransformMode===`tf_crop_and_resize`)throw Error(`Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize`);if(s>0&&e.length>s&&e[s].dims.length===1&&e[s].dims[0]>0){if(e[s].getFloat32Array().forEach(e=>r.push(e)),r.length!==0&&r.length!==l&&n>=18&&r.length!==t.axes.length)throw Error(`Resize requires scales input size to be same as input rank or axes size for opset 18 and up`);Wl(r,t),t.axes.length>0&&Gl(r,t.axes,l).forEach((e,t)=>r[t]=e)}if(c>0&&e.length>c&&e[c].dims.length===1&&e[c].dims[0]>0&&(e[c].getBigInt64Array().forEach(e=>i.push(Number(e))),i.length!==0&&i.length!==l&&n>=18&&i.length!==t.axes.length))throw Error(`Resize requires sizes input size to be same as input rank or axes size for opset 18 and up`);if(t.axes.length>0){if(r.length!==0&&r.length!==t.axes.length)throw Error(`Resize requires "scales" input size to be of axes rank when axes attributes is specified`);if(i.length!==0&&i.length!==t.axes.length)throw Error(`Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified`)}if(typeof r<`u`&&typeof i<`u`&&r.length>0&&i.length>l)throw Error(`Resize requires only of scales or sizes to be specified`)},ql=(e,t,n,r)=>`
...
`,Jl=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case`asymmetric`:return`
          if (xScale < 1.0 || floor(xScale) != xScale) {
            ...
            ${ql(`xResized`,`lengthOriginal`,`lengthResized`,t)}
          }
        `;case`pytorch_half_pixel`:return`if (lengthResized > 1) {
                    ...
                    ${ql(`xResized`,`lengthOriginal - 1`,`lengthResized - 1`,t)}
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case`half_pixel`:return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw Error(`Coordinate transform mode ${e} is not supported`)}})()+`}`,Yl=(e,t,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(e){case`round_prefer_ceil`:return`if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }`;case`floor`:return`return floor(xOriginal);`;case`ceil`:return`return ceil(xOriginal);`;case`round_prefer_floor`:return`if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }`;default:if(t<11)return`if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }`;throw Error(`Nearest mode ${e} is not supported`)}})()+`}`,Xl=(e,t,n)=>{let r=Array(n).fill(0).concat(Array(n).fill(1)),i=e.length===0?r:e.slice();return t.length>0?(t.forEach((e,a)=>{r[e]=i[a],r[a+n]=i[t.length+a]}),r):i},Zl=(e,t,n,r)=>{let i=[];if(n.length>0){if(r.length>0){if(e.forEach(e=>i.push(e)),Math.max(...r)>e.length)throw Error(`axes is out of bound`);r.forEach((e,t)=>i[e]=n[t])}else n.forEach(e=>i.push(e))}else{if(t.length===0)throw Error(`Resize requires either scales or sizes.`);i=e.map((e,n)=>Math.round(e*t[n]))}return i},Ql=(e,t,n)=>{let r=(()=>{switch(n.keepAspectRatioPolicy){case`not_larger`:return n.axes.length>0?Math.min(...n.axes.map(e=>t[e]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case`not_smaller`:return n.axes.length>0?Math.max(...n.axes.map(e=>t[e]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return n.axes.length>0?(n.axes.forEach(e=>t[e]=r),n.axes.forEach(n=>i[n]=Math.round(e[n]*t[n]))):(t.fill(r,0,t.length),i.forEach((e,n)=>i[n]=Math.round(e*t[n]))),i},$l=(e,t,n,r,i)=>`
...
`:``,ru=(e,t,n,r,i)=>{let[a,o,s,c]=n.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},iu=(e,t,n,r,i,a,o,s,c,l)=>{let[u,d]=n.length===2?[0,1]:[2,3],f=e.type.value,p=o=>{let d=o===u?`row`:`col`;return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${f} {
    ...
    `},au=(e,t,n,r,i)=>{let[a,o,s,c,l]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],u=e.type.value;return`
    ...
    }`},ou=(e,t,n,r,i,a)=>{let o=e.dims,s=Xl(a,t.axes,o.length),c=Zl(o,r,i,t.axes),l=r.slice();r.length===0&&(l=o.map((e,t)=>e===0?1:c[t]/e),t.keepAspectRatioPolicy!==`stretch`&&(c=Ql(o,l,t)));let u=J(`output`,e.dataType,c.length),d=q(`input`,e.dataType,o.length),f=R.size(c),p=o.length===c.length&&o.every((e,t)=>e===c[t]),m=t.coordinateTransformMode===`tf_crop_and_resize`,h=t.extrapolationValue,g=d.type.value;return{name:`Resize`,shaderCache:{hint:`${t.cacheKey}|${n}|${l.length>0?t.mode===`cubic`?l:l.length:``}|${i.length>0?i:``}|${s.length>0?s:``}|${p}|${t.mode===`nearest`?o.length:o}`,inputDependencies:[`rank`]},getShaderSource:e=>`
      ${p?``:`
      ${Jl(t.coordinateTransformMode,g)};
      ${(()=>{switch(t.mode){case`nearest`:return`
              ${tu(d,o)};
              ${Yl(t.nearestMode,n,g)};
              ${eu(d,u,o,c,l.length,s.length,m)};
              `;case`linear`:return`
              ${$l(u,o,c,l.length,s.length)};
              ${(()=>{if(o.length===2||o.length===4)return`${ru(d,u,o,m,h)}`;if(o.length===3||o.length===5)return`${au(d,u,o,m,h)}`;throw Error(`Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.`)})()};
            `;case`cubic`:return`
            ${(()=>{if(o.length===2||o.length===4)return`${iu(d,u,o,c,l,s,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error(`Cubic mode only supports input dims 2 and 4 are supported in linear mode.`)})()};
...
`}
      ...
      }`},y=[{dims:s,dataType:e[0].dataType}];return n>1&&y.push({dims:u,dataType:1}),n>2&&y.push({dims:u,dataType:1}),n>3&&y.push({dims:a,dataType:e[0].dataType}),{name:`SkipLayerNormalization`,shaderCache:{hint:`${g};${p};${m};${h}`,inputDependencies:e.map((e,t)=>`type`)},getShaderSource:v,getRunData:()=>({outputs:y,dispatchGroup:{x:Math.ceil(c/l)},programUniforms:_})}},pu=(e,t)=>{du(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(fu(e.inputs,t,e.outputCount,!1),{outputs:n})}}),hu,gu,_u,vu,yu,bu,xu,Su,Cu=d(()=>{I(),z(),V(),Y(),hu=(e,t)=>{if(!e||e.length<1)throw Error(`too few inputs`);if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw Error(`axes, starts and ends must have the same length`)}else if(t.starts.length!==t.ends.length)throw Error(`starts and ends must have the same length`);e.slice(1).forEach((t,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw Error(`Input ${n} must be an array of int32 or int64`)})},gu=(e,t)=>{let n=[];if(e.length>t){if(e[t].dataType===7)e[t].getBigInt64Array().forEach(e=>n.push(Number(e)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(e=>n.push(Number(e)));else throw Error(`Input ${t} must be an array of int32 or int64`)}return n},_u=(e,t)=>{if(e.length>1){let t=gu(e,1),n=gu(e,2),r=gu(e,3);return r.length===0&&(r=[...Array(e[0].dims.length).keys()]),B({starts:t,ends:n,axes:r})}return t},vu=(e,t,n,r,i)=>{let a=e;return e<0&&(a+=n[r[t]]),i[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},yu=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      ${c.setByOffset(`global_idx`,s.getByIndices(`input_indices`))}
    }`}},Nu=e=>{Au(e.inputs),e.compute(Mu(e.inputs),{inputs:[0]})}}),Fu,Iu,Lu,Ru=d(()=>{I(),z(),Y(),Fu=(e,t,n,r,i)=>{let a=J(`output_data`,i,n.length,4),o=q(`a_data`,t[1].dataType,t[1].dims.length,4),s=q(`b_data`,t[2].dataType,t[2].dims.length,4),c=q(`c_data`,t[0].dataType,t[0].dims.length,4),l,u=(e,t,n)=>`select(${t}, ${e}, ${n})`;if(!r)l=a.setByOffset(`global_idx`,u(o.getByOffset(`global_idx`),s.getByOffset(`global_idx`),c.getByOffset(`global_idx`)));else{let e=(e,t,n=``)=>{let r=`a_data[index_a${t}][component_a${t}]`,i=`b_data[index_b${t}][component_b${t}]`,l=`bool(c_data[index_c${t}] & (0xffu << (component_c${t} * 8)))`;return`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes(`uniforms.vec_size`)}
        ${l}
      }`},Iu=e=>{let t=e[1].dims,n=e[2].dims,r=e[0].dims,i=e[1].dataType,a=!(R.areEqual(t,n)&&R.areEqual(n,r)),o=t,s=R.size(t);if(a){let e=Wt.calcShape(Wt.calcShape(t,n,!1),r,!1);if(!e)throw Error(`Can't perform where op on the given tensors`);o=e,s=R.size(o)}let c=Math.ceil(s/4);return{name:`Where`,shaderCache:{inputDependencies:[`rank`,`rank`,`rank`]},getShaderSource:t=>Fu(t,e,o,a,i),getRunData:()=>({outputs:[{dims:o,dataType:i}],dispatchGroup:{x:Math.ceil(s/64/4)},programUniforms:[{type:12,data:c},...W(r,t,n,o)]})}},Lu=e=>{e.compute(Iu(e.inputs))}}),zu,Bu=d(()=>{Hr(),Zr(),ni(),oi(),na(),ga(),Ca(),_o(),ko(),No(),zo(),rs(),hs(),xs(),ws(),ks(),Ns(),Rs(),Us(),Js(),lc(),Fc(),Bc(),Wc(),qc(),$c(),_c(),ll(),kl(),Pl(),Rl(),Ul(),Lr(),uu(),kc(),mu(),Cu(),Ou(),Tc(),Pu(),Gn(),Qi(),Ru(),zu=new Map([[`Abs`,[ci]],[`Acos`,[li]],[`Acosh`,[ui]],[`Add`,[oa]],[`ArgMax`,[Br,Vr]],[`ArgMin`,[zr,Vr]],[`Asin`,[di]],[`Asinh`,[fi]],[`Atan`,[pi]],[`Atanh`,[mi]],[`Attention`,[Xr]],[`AveragePool`,[bl,yl]],[`BatchNormalization`,[ti]],[`BiasAdd`,[ai]],[`BiasSplitGelu`,[ta]],[`Cast`,[gi,hi]],[`Ceil`,[yi]],[`Clip`,[vi]],[`Concat`,[xa,Sa]],[`Conv`,[go,fo]],[`ConvTranspose`,[Oo,wo]],[`Cos`,[bi]],[`Cosh`,[xi]],[`CumSum`,[jo,Mo]],[`DepthToSpace`,[Lo,Ro]],[`DequantizeLinear`,[Ml,Nl]],[`DFT`,[ts,ns]],[`Div`,[sa]],[`Einsum`,[ps,ms]],[`Elu`,[Ci,Si]],[`Equal`,[ca]],[`Erf`,[Ti]],[`Exp`,[Ei]],[`Expand`,[bs]],[`FastGelu`,[Cs]],[`Floor`,[Di]],[`FusedConv`,[go,fo]],[`Gather`,[Os,Ds]],[`GatherElements`,[Hs,Vs]],[`GatherBlockQuantized`,[Is,Ls]],[`GatherND`,[js,Ms]],[`Gelu`,[Oi]],[`Gemm`,[qs,Ks]],[`GlobalAveragePool`,[Cl,Sl]],[`GlobalMaxPool`,[Ol,Dl]],[`Greater`,[fa]],[`GreaterOrEqual`,[ma]],[`GridSample`,[sc,cc]],[`GroupQueryAttention`,[Pc]],[`HardSigmoid`,[Ii,Fi]],[`HardSwish`,[Li]],[`InstanceNormalization`,[zc]],[`LayerNormalization`,[Uc]],[`LeakyRelu`,[ki,Si]],[`Less`,[pa]],[`LessOrEqual`,[ha]],[`Log`,[Ji]],[`MatMul`,[Kc]],[`MatMulNBits`,[Zc,Qc]],[`MaxPool`,[Tl,El]],[`Mul`,[la]],[`MultiHeadAttention`,[gc,fc]],[`Neg`,[ji]],[`Not`,[Ai]],[`Pad`,[cl]],[`Pow`,[ua]],[`QuickGelu`,[Zi,Si]],[`Range`,[Ll]],[`Reciprocal`,[Mi]],[`ReduceMin`,[Mr]],[`ReduceMean`,[Dr]],[`ReduceMax`,[jr]],[`ReduceSum`,[Pr]],[`ReduceProd`,[Nr]],[`ReduceL1`,[Or]],[`ReduceL2`,[kr]],[`ReduceLogSum`,[Ir]],[`ReduceLogSumExp`,[Ar]],[`ReduceSumSquare`,[Fr]],[`Relu`,[Ni]],[`Resize`,[cu,lu]],[`RotaryEmbedding`,[Oc]],[`ScatterND`,[Hl,Vl]],[`Sigmoid`,[Pi]],[`Sin`,[Ri]],[`Sinh`,[zi]],[`Slice`,[xu,Su]],[`SkipLayerNormalization`,[pu]],[`Split`,[Cc,wc]],[`Sqrt`,[Bi]],[`Softmax`,[Eu,Du]],[`Sub`,[da]],[`Tan`,[Vi]],[`Tanh`,[Ui]],[`ThresholdedRelu`,[qi,Si]],[`Tile`,[Nu]],[`Transpose`,[Un,Wn]],[`Where`,[Lu]]])}),Vu,Hu=d(()=>{Ne(),Ht(),Y(),Vu=class{constructor(e){this.backend=e,this.repo=new Map,this.attributesBound=!1}getArtifact(e){return this.repo.get(e)}setArtifact(e,t){this.repo.set(e,t)}run(e,t,n,r,i){be(e.programInfo.name);let a=this.backend.device,o=this.backend.getComputePassEncoder();this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2);let s=[];for(let e of t)s.push({binding:s.length,resource:{buffer:e.buffer}});for(let e of n)s.push({binding:s.length,resource:{buffer:e.buffer}});i&&s.push({binding:s.length,resource:i});let c=a.createBindGroup({layout:e.computePipeline.getBindGroupLayout(0),entries:s,label:e.programInfo.name});if(this.backend.sessionStatus===`capturing`){let t={kernelId:this.backend.currentKernelId,computePipeline:e.computePipeline,bindGroup:c,dispatchGroup:r};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(t)}o.setPipeline(e.computePipeline),o.setBindGroup(0,c),o.dispatchWorkgroups(...r),this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||this.backend.queryType===`at-passes`)&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),xe(e.programInfo.name)}dispose(){}build(e,t){be(e.name);let n=this.backend.device,r=[];[{feature:`shader-f16`,extension:`f16`},{feature:`subgroups`,extension:`subgroups`}].forEach(e=>{n.features.has(e.feature)&&r.push(`enable ${e.extension};`)});let i=Fn(t,this.backend.device.limits),a=e.getShaderSource(i),o=`${r.join(`
`)}
${i.additionalImplementations}
${a}`,s=n.createShaderModule({code:o,label:e.name});L(`verbose`,()=>`[WebGPU] ${e.name} shader code: ${o}`);let c=n.createComputePipeline({compute:{module:s,entryPoint:`main`},layout:`auto`,label:e.name});return xe(e.name),{programInfo:e,computePipeline:c,uniformVariablesInfo:i.variablesInfo}}normalizeDispatchGroupSize(e){let t=typeof e==`number`?e:e.x,n=typeof e==`number`?1:e.y||1,r=typeof e==`number`?1:e.z||1,i=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(t<=i&&n<=i&&r<=i)return[t,n,r];let a=t*n*r,o=Math.ceil(Math.sqrt(a));if(o>i){if(o=Math.ceil(Math.cbrt(a)),o>i)throw Error(`Total dispatch size exceeds WebGPU maximum.`);return[o,o,o]}return[o,o,1]}}}),Uu={};f(Uu,{WebGpuBackend:()=>qu});var Wu,Gu,Ku,qu,Ju=d(()=>{Ne(),I(),Ht(),Xt(),wn(),Bu(),Hu(),Wu=(e,t)=>{if(t.length!==e.length)throw Error(`inputDependencies length ${t.length} is not equal to inputTensors length ${e.length}.`);let n=[];for(let r=0;r<e.length;++r){let i=e[r].dataType;switch(t[r]){case`none`:n.push(``);break;case`type`:n.push(`${i}`);break;case`rank`:{let t=e[r].dims.length;n.push(`${i};${t}`);break}case`dims`:{let t=e[r].dims.join(`,`);n.push(`${i};${t}`);break}default:throw Error(`unsupported input dependency: ${t[r]}`)}}return n.join(`|`)},Gu=(e,t,n)=>{let r=e.name;return e.shaderCache?.hint&&(r+=`[`+e.shaderCache.hint+`]`),r+=`:`+n+`:${Wu(t,e.shaderCache?.inputDependencies??Array(t.length).fill(`dims`))}`,r},Ku=class{constructor(e){e&&(this.architecture=e.architecture,this.vendor=e.vendor)}isArchitecture(e){return this.architecture===e}isVendor(e){return this.vendor===e}},qu=class{constructor(){this.currentSessionId=null,this.currentKernelId=null,this.commandEncoder=null,this.computePassEncoder=null,this.maxDispatchNumber=16,this.pendingDispatchNumber=0,this.pendingKernels=[],this.pendingQueries=new Map,this.sessionStatus=`default`,this.capturedCommandList=new Map,this.capturedPendingKernels=new Map,this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(this.currentKernelId===null)throw Error(`currentKernelCustomData(): currentKernelId is null. (should not happen)`);let e=this.kernelCustomData.get(this.currentKernelId);return e||(e={},this.kernelCustomData.set(this.currentKernelId,e)),e}async initialize(e,t){this.env=e;let n=[],r={requiredLimits:{maxComputeWorkgroupStorageSize:t.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:t.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:t.limits.maxStorageBufferBindingSize,maxBufferSize:t.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:t.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:t.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:t.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:t.limits.maxComputeWorkgroupSizeZ},requiredFeatures:n},i=e=>t.features.has(e)&&n.push(e)&&!0;i(`chromium-experimental-timestamp-query-inside-passes`)||i(`timestamp-query`),i(`shader-f16`),i(`subgroups`),this.device=await t.requestDevice(r);let a=t,o=t.info??(typeof a.requestAdapterInfo==`function`?await a.requestAdapterInfo():void 0);this.adapterInfo=new Ku(o),this.gpuDataManager=Cn(this),this.programManager=new Vu(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,Bt(e.logLevel,!!e.debug),this.device.onuncapturederror=e=>{e.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${e.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!0}),Object.defineProperty(this.env.webgpu,"adapter",{value:t,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){typeof this.querySet<`u`&&this.querySet.destroy(),this.gpuDataManager.dispose(),this.device&&this.env?.webgpu&&this.device.lost.then(()=>{delete this.env.webgpu.device})}getCommandEncoder(){return this.commandEncoder||=this.device.createCommandEncoder(),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let e=this.getCommandEncoder(),t={};this.queryType===`at-passes`&&(t.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:this.pendingDispatchNumber*2,endOfPassWriteIndex:this.pendingDispatchNumber*2+1}),this.computePassEncoder=e.beginComputePass(t)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&=(this.computePassEncoder.end(),null)}flush(){if(!this.commandEncoder)return;be(),this.endComputePass();let e;this.queryType!==`none`&&(this.commandEncoder.resolveQuerySet(this.querySet,0,this.pendingDispatchNumber*2,this.queryResolveBuffer,0),e=this.device.createBuffer({size:this.pendingDispatchNumber*2*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(e,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,e,0,this.pendingDispatchNumber*2*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,this.queryType!==`none`&&e.mapAsync(GPUMapMode.READ).then(()=>{let t=new BigUint64Array(e.getMappedRange()),n=this.pendingQueries.get(e);for(let e=0;e<t.length/2;e++){let r=n[e],i=r.kernelId,a=this.kernels.get(i),o=a.kernelType,s=a.kernelName,c=r.programName,l=r.inputTensorViews,u=r.outputTensorViews,d=t[e*2],f=t[e*2+1];typeof this.queryTimeBase>`u`&&(this.queryTimeBase=d);let p=Number(d-this.queryTimeBase),m=Number(f-this.queryTimeBase);if(!Number.isSafeInteger(p)||!Number.isSafeInteger(m))throw RangeError(`incorrect timestamp range`);if(this.env.webgpu.profiling?.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:l.map(e=>({dims:e.dims,dataType:Dt(e.dataType)})),outputsMetadata:u.map(e=>({dims:e.dims,dataType:Dt(e.dataType)})),kernelId:i,kernelType:o,kernelName:s,programName:c,startTime:p,endTime:m});else{let e=``;l.forEach((t,n)=>{e+=`input[${n}]: [${t.dims}] | ${Dt(t.dataType)}, `});let t=``;u.forEach((e,n)=>{t+=`output[${n}]: [${e.dims}] | ${Dt(e.dataType)}, `}),console.log(`[profiling] kernel "${i}|${o}|${s}|${c}" ${e}${t}start time: ${p} ns, execution time: ${m-p} ns`)}ve(`GPU`,`${c}::${d}::${f}`)}e.unmap(),this.pendingQueries.delete(e)}),xe()}run(e,t,n,r,i,a){be(e.name);let o=[];for(let e=0;e<t.length;++e){let n=t[e].data;if(n===0)continue;let r=this.gpuDataManager.get(n);if(!r)throw Error(`no GPU data for input: ${n}`);o.push(r)}let{outputs:s,dispatchGroup:c,programUniforms:l}=e.getRunData(t),u=n.length===0?s.map((e,t)=>t):n;if(u.length!==s.length)throw Error(`Output size ${u.length} must be equal to ${s.length}.`);let d=[],f=[];for(let e=0;e<s.length;++e){if(!Number.isInteger(u[e])||u[e]<-3||u[e]>=a)throw Error(`Invalid output index: ${u[e]}`);if(u[e]===-3)continue;let t=u[e]===-1,n=u[e]===-2,o=t||n?i(s[e].dataType,s[e].dims):r(u[e],s[e].dataType,s[e].dims);if(d.push(o),o.data===0)continue;let c=this.gpuDataManager.get(o.data);if(!c)throw Error(`no GPU data for output: ${o.data}`);if(t&&this.temporaryData.push(c),n){let e=this.kernelPersistentData.get(this.currentKernelId);e||(e=[],this.kernelPersistentData.set(this.currentKernelId,e)),e.push(c)}f.push(c)}if(o.length!==t.length||f.length!==d.length){if(f.length===0)return xe(e.name),d;throw Error(`Program ${e.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}let p;if(l){let e=0,t=[];l.forEach(n=>{let r=typeof n.data==`number`?[n.data]:n.data;if(r.length===0)return;let i=n.type===10?2:4,a,o;n.type===10?(o=r.length>4?16:r.length>2?8:r.length*i,a=r.length>4?16:i*r.length):(o=r.length<=2?r.length*i:16,a=16),e=Math.ceil(e/o)*o,t.push(e);let s=n.type===10?8:4;e+=r.length>4?Math.ceil(r.length/s)*a:r.length*i}),e=Math.ceil(e/16)*16;let n=new ArrayBuffer(e);l.forEach((e,r)=>{let i=t[r],a=typeof e.data==`number`?[e.data]:e.data;if(e.type===6)new Int32Array(n,i,a.length).set(a);else if(e.type===12)new Uint32Array(n,i,a.length).set(a);else if(e.type===10)new Uint16Array(n,i,a.length).set(a);else if(e.type===1)new Float32Array(n,i,a.length).set(a);else throw Error(`Unsupported uniform type: ${Dt(e.type)}`)});let r=this.gpuDataManager.create(e,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(r.buffer,0,n,0,e),this.gpuDataManager.release(r.id),p={offset:0,size:e,buffer:r.buffer}}let m=this.programManager.normalizeDispatchGroupSize(c),h=m[1]===1&&m[2]===1,g=Gu(e,t,h),_=this.programManager.getArtifact(g);if(_||(_=this.programManager.build(e,m),this.programManager.setArtifact(g,_),L(`info`,()=>`[artifact] key: ${g}, programName: ${e.name}`)),l&&_.uniformVariablesInfo){if(l.length!==_.uniformVariablesInfo.length)throw Error(`Uniform variables count mismatch: expect ${_.uniformVariablesInfo.length}, got ${l.length} in program "${_.programInfo.name}".`);for(let e=0;e<l.length;e++){let t=l[e],n=t.type,r=typeof t.data==`number`?1:t.data.length,[i,a]=_.uniformVariablesInfo[e];if(n!==i||r!==a)throw Error(`Uniform variable ${e} mismatch: expect type ${i} with size ${a}, got type ${n} with size ${r} in program "${_.programInfo.name}".`)}}if(L(`info`,()=>`[ProgramManager] run "${e.name}" (key=${g}) with ${m[0]}x${m[1]}x${m[2]}`),this.queryType!==`none`||this.sessionStatus===`capturing`){let e={kernelId:this.currentKernelId,programName:_.programInfo.name,inputTensorViews:t,outputTensorViews:d};this.pendingKernels.push(e),this.sessionStatus===`capturing`&&this.capturedPendingKernels.get(this.currentSessionId).push(e)}return this.programManager.run(_,o,f,m,p),xe(e.name),d}upload(e,t){this.gpuDataManager.upload(e,t)}memcpy(e,t){this.gpuDataManager.memcpy(e,t)}async download(e,t){await this.gpuDataManager.download(e,t)}alloc(e){return this.gpuDataManager.create(e).id}free(e){return this.gpuDataManager.release(e)}createKernel(e,t,n,r){let i=zu.get(e);if(!i)throw Error(`kernel not implemented: ${e}`);let a={kernelType:e,kernelName:r,kernelEntry:i[0],attributes:[i[1],n]};this.kernels.set(t,a)}releaseKernel(e){let t=this.kernelPersistentData.get(e);if(t){for(let e of t)this.gpuDataManager.release(e.id);this.kernelPersistentData.delete(e)}this.kernelCustomData.delete(e),this.kernels.delete(e)}computeKernel(e,t,n){let r=this.kernels.get(e);if(!r)throw Error(`kernel not created: ${e}`);let i=r.kernelType,a=r.kernelName,o=r.kernelEntry,s=r.attributes;if(this.currentKernelId!==null)throw Error(`kernel "[${i}] ${a}" is not allowed to be called recursively`);this.currentKernelId=e,s[0]&&=(s[1]=s[0](s[1]),void 0),L(`info`,()=>`[WebGPU] Start to run kernel "[${i}] ${a}"...`);let c=this.env.debug;this.temporaryData=[];try{return c&&this.device.pushErrorScope(`validation`),o(t,s[1]),0}catch(e){return n.push(Promise.resolve(`[WebGPU] Kernel "[${i}] ${a}" failed. ${e}`)),1}finally{c&&n.push(this.device.popErrorScope().then(e=>e?`GPU validation error for kernel "[${i}] ${a}": ${e.message}`:null));for(let e of this.temporaryData)this.gpuDataManager.release(e.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(e,t,n,r){let i=this.sessionExternalDataMapping.get(e);i||(i=new Map,this.sessionExternalDataMapping.set(e,i));let a=i.get(t),o=this.gpuDataManager.registerExternalBuffer(n,r,a);return i.set(t,[o,n]),o}unregisterBuffers(e){let t=this.sessionExternalDataMapping.get(e);t&&(t.forEach(e=>this.gpuDataManager.unregisterExternalBuffer(e[0])),this.sessionExternalDataMapping.delete(e))}getBuffer(e){let t=this.gpuDataManager.get(e);if(!t)throw Error(`no GPU data for buffer: ${e}`);return t.buffer}createDownloader(e,t,n){return async()=>{let r=await xn(this,e,t);return Yt(r.buffer,n)}}writeTimestamp(e){this.queryType===`inside-passes`&&this.computePassEncoder.writeTimestamp(this.querySet,e)}setQueryType(){this.queryType=`none`,(this.env.webgpu.profiling?.mode==="default"||(typeof this.env.trace>`u`?this.env.wasm.trace:this.env.trace))&&(this.device.features.has(`chromium-experimental-timestamp-query-inside-passes`)?this.queryType=`inside-passes`:this.device.features.has(`timestamp-query`)&&(this.queryType=`at-passes`),this.queryType!==`none`&&typeof this.querySet>`u`&&(this.querySet=this.device.createQuerySet({type:`timestamp`,count:this.maxDispatchNumber*2}),this.queryResolveBuffer=this.device.createBuffer({size:this.maxDispatchNumber*2*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){L(`info`,`captureBegin`),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus=`capturing`}captureEnd(){L(`info`,`captureEnd`),this.flush(),this.sessionStatus=`default`}replay(){L(`info`,`replay`),this.sessionStatus=`replaying`;let e=this.capturedCommandList.get(this.currentSessionId),t=this.capturedPendingKernels.get(this.currentSessionId),n=e.length;this.pendingKernels=[];for(let r=0;r<n;r++){let n=this.getComputePassEncoder(),i=e[r];this.writeTimestamp(this.pendingDispatchNumber*2),n.setPipeline(i.computePipeline),n.setBindGroup(0,i.bindGroup),n.dispatchWorkgroups(...i.dispatchGroup),this.writeTimestamp(this.pendingDispatchNumber*2+1),this.pendingDispatchNumber++,this.queryType!==`none`&&this.pendingKernels.push(t[r]),(this.pendingDispatchNumber>=this.maxDispatchNumber||this.queryType===`at-passes`)&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus=`default`}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(e){this.unregisterBuffers(e),this.capturedCommandList.has(e)&&this.capturedCommandList.delete(e),this.capturedPendingKernels.has(e)&&this.capturedPendingKernels.delete(e),this.gpuDataManager.onReleaseSession(e)}onRunStart(e){this.currentSessionId=e,this.setQueryType()}}}),Yu={};f(Yu,{init:()=>Qu});var Xu,Zu,Qu,$u=d(()=>{I(),Ht(),z(),pn(),Xu=class e{constructor(e,t,n,r){this.module=e,this.dataType=t,this.data=n,this.dims=r}getFloat32Array(){if(this.dataType!==1)throw Error(`Invalid data type`);let e=R.size(this.dims);return e===0?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,e)}getBigInt64Array(){if(this.dataType!==7)throw Error(`Invalid data type`);let e=R.size(this.dims);return e===0?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,e)}getInt32Array(){if(this.dataType!==6)throw Error(`Invalid data type`);let e=R.size(this.dims);return e===0?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,e)}getUint16Array(){if(this.dataType!==10&&this.dataType!==4)throw Error(`Invalid data type`);let e=R.size(this.dims);return e===0?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,e)}reshape(t){if(R.size(t)!==R.size(this.dims))throw Error(`Invalid new shape`);return new e(this.module,this.dataType,this.data,t)}},Zu=class{constructor(e,t,n){this.module=e,this.backend=t,this.customDataOffset=0,this.customDataSize=0,this.adapterInfo=t.adapterInfo;let r=e.PTR_SIZE,i=n/e.PTR_SIZE,a=r===4?`i32`:`i64`;this.opKernelContext=Number(e.getValue(r*i++,a));let o=Number(e.getValue(r*i++,a));this.outputCount=Number(e.getValue(r*i++,a)),this.customDataOffset=Number(e.getValue(r*i++,`*`)),this.customDataSize=Number(e.getValue(r*i++,a));let s=[];for(let t=0;t<o;t++){let t=Number(e.getValue(r*i++,a)),n=Number(e.getValue(r*i++,`*`)),o=Number(e.getValue(r*i++,a)),c=[];for(let t=0;t<o;t++)c.push(Number(e.getValue(r*i++,a)));s.push(new Xu(e,t,n,c))}this.inputs=s}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(e,t){let n=t?.inputs?.map(e=>typeof e==`number`?this.inputs[e]:e)??this.inputs,r=t?.outputs??[];return this.backend.run(e,n,r,(e,t,n)=>new Xu(this.module,t,this.output(e,n),n),(e,t)=>{let n=Ot(e,t);if(!n)throw Error(`Unsupported data type: ${e}`);let r=n>0?this.backend.gpuDataManager.create(n).id:0;return new Xu(this.module,e,r,t)},this.outputCount)}output(e,t){let n=this.module.stackSave();try{let n=this.module.PTR_SIZE,r=n===4?`i32`:`i64`,i=this.module.stackAlloc((1+t.length)*n);this.module.setValue(i,t.length,r);for(let e=0;e<t.length;e++)this.module.setValue(i+n*(e+1),t[e],r);return this.module._JsepOutput(this.opKernelContext,e,i)}catch(n){throw Error(`Failed to generate kernel's output[${e}] with dims [${t}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${n}`)}finally{this.module.stackRestore(n)}}},Qu=async(e,t,n,r)=>{let i=t.jsepInit;if(!i)throw Error(`Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.`);if(e===`webgpu`){let e=(Ju(),m(Uu)).WebGpuBackend,a=new e;await a.initialize(n,r),i(`webgpu`,[a,e=>a.alloc(Number(e)),e=>a.free(e),(e,n,r,i=!1)=>{if(i)L(`verbose`,()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(e)}, dst=${Number(n)}, size=${Number(r)}`),a.memcpy(Number(e),Number(n));else{L(`verbose`,()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(e)}, gpuDataId=${Number(n)}, size=${Number(r)}`);let i=t.HEAPU8.subarray(Number(e>>>0),Number(e>>>0)+Number(r));a.upload(Number(n),i)}},async(e,n,r)=>{L(`verbose`,()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${e}, dataOffset=${n}, size=${r}`),await a.download(Number(e),()=>t.HEAPU8.subarray(Number(n)>>>0,Number(n+r)>>>0))},(e,n,r)=>a.createKernel(e,Number(n),r,t.UTF8ToString(t._JsepGetNodeName(Number(n)))),e=>a.releaseKernel(e),(e,n,r,i)=>{L(`verbose`,()=>`[WebGPU] jsepRun: sessionHandle=${r}, kernel=${e}, contextDataOffset=${n}`);let o=new Zu(t,a,Number(n));return a.computeKernel(Number(e),o,i)},()=>a.captureBegin(),()=>a.captureEnd(),()=>a.replay()])}else{let e=new fn(n);i(`webnn`,[e,()=>e.reserveTensorId(),t=>e.releaseTensorId(t),async(t,n,r,i,a)=>e.ensureTensor(t,n,r,i,a),(t,n)=>{e.uploadTensor(t,n)},async(t,n)=>e.downloadTensor(t,n),(t,n)=>e.registerMLContext(t,n),!!n.trace])}}}),ed,td,nd,rd,id,ad,od,sd,cd,ld,ud,dd,fd,pd=d(()=>{Ne(),vt(),Tt(),I(),pt(),gt(),Ft(),ed=(e,t)=>{P()._OrtInit(e,t)!==0&&F(`Can't initialize onnxruntime.`)},td=async e=>{ed(e.wasm.numThreads,At(e.logLevel))},nd=async(e,t)=>{P().asyncInit?.();let n=e.webgpu.adapter;if(t===`webgpu`){if(typeof navigator>`u`||!navigator.gpu)throw Error(`WebGPU is not supported in current environment`);if(n){if(typeof n.limits!=`object`||typeof n.features!=`object`||typeof n.requestDevice!=`function`)throw Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let t=e.webgpu.powerPreference;if(t!==void 0&&t!==`low-power`&&t!==`high-performance`)throw Error(`Invalid powerPreference setting: "${t}"`);let r=e.webgpu.forceFallbackAdapter;if(r!==void 0&&typeof r!=`boolean`)throw Error(`Invalid forceFallbackAdapter setting: "${r}"`);if(n=await navigator.gpu.requestAdapter({powerPreference:t,forceFallbackAdapter:r}),!n)throw Error(`Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.`)}}if(t===`webnn`&&(typeof navigator>`u`||!navigator.ml))throw Error(`WebNN is not supported in current environment`);{let r=($u(),m(Yu)).init;t===`webgpu`&&await r(`webgpu`,P(),e,n),t===`webnn`&&await r(`webnn`,P(),e)}},rd=new Map,id=e=>{let t=P(),n=t.stackSave();try{let n=t.PTR_SIZE,r=t.stackAlloc(2*n);t._OrtGetInputOutputCount(e,r,r+n)!==0&&F(`Can't get session input/output count.`);let i=n===4?`i32`:`i64`;return[Number(t.getValue(r,i)),Number(t.getValue(r+n,i))]}finally{t.stackRestore(n)}},ad=(e,t)=>{let n=P(),r=n.stackSave(),i=0;try{let r=n.PTR_SIZE,a=n.stackAlloc(2*r);n._OrtGetInputOutputMetadata(e,t,a,a+r)!==0&&F(`Can't get session input/output metadata.`);let o=Number(n.getValue(a,`*`));i=Number(n.getValue(a+r,`*`));let s=n.HEAP32[i/4];if(s===0)return[o,0];let c=n.HEAPU32[i/4+1],l=[];for(let e=0;e<c;e++){let t=Number(n.getValue(i+8+e*r,`*`));l.push(t===0?Number(n.getValue(i+8+(e+c)*r,`*`)):n.UTF8ToString(t))}return[o,s,l]}finally{n.stackRestore(r),i!==0&&n._OrtFree(i)}},od=e=>{let t=P(),n=t._malloc(e.byteLength);if(n===0)throw Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return t.HEAPU8.set(e,n),[n,e.byteLength]},sd=async(e,t)=>{let n,r,i=P();Array.isArray(e)?[n,r]=e:e.buffer===i.HEAPU8.buffer?[n,r]=[e.byteOffset,e.byteLength]:[n,r]=od(e);let a=0,o=0,s=0,c=[],l=[],u=[];try{if([o,c]=await wt(t),t?.externalData&&i.mountExternalData){let e=[];for(let n of t.externalData){let t=typeof n==`string`?n:n.path,r=typeof n==`string`?n:n.data;e.push(Pt(r).then(e=>{i.mountExternalData(t,e)}))}await Promise.all(e)}for(let e of t?.executionProviders??[])if((typeof e==`string`?e:e.name)===`webnn`){if(i.shouldTransferToMLTensor=!1,typeof e!=`string`){let t=e,n=t?.context,r=t?.gpuDevice,a=t?.deviceType,o=t?.powerPreference;i.currentContext=n||(r?await i.webnnCreateMLContext(r):await i.webnnCreateMLContext({deviceType:a,powerPreference:o}))}else i.currentContext=await i.webnnCreateMLContext();break}a=await i._OrtCreateSession(n,r,o),i.webgpuOnCreateSession?.(a),a===0&&F(`Can't create a session.`),i.jsepOnCreateSession?.(),i.currentContext&&(i.webnnRegisterMLContext(a,i.currentContext),i.currentContext=void 0,i.shouldTransferToMLTensor=!0);let[e,d]=id(a),f=!!t?.enableGraphCapture,p=[],m=[],h=[],g=[],_=[];for(let t=0;t<e;t++){let[e,n,r]=ad(a,t);e===0&&F(`Can't get an input name.`),l.push(e);let o=i.UTF8ToString(e);p.push(o),h.push(n===0?{name:o,isTensor:!1}:{name:o,isTensor:!0,type:Dt(n),shape:r})}for(let n=0;n<d;n++){let[r,o,s]=ad(a,n+e);r===0&&F(`Can't get an output name.`),u.push(r);let c=i.UTF8ToString(r);m.push(c),g.push(o===0?{name:c,isTensor:!1}:{name:c,isTensor:!0,type:Dt(o),shape:s});{if(f&&t?.preferredOutputLocation===void 0){_.push(`gpu-buffer`);continue}let e=typeof t?.preferredOutputLocation==`string`?t.preferredOutputLocation:t?.preferredOutputLocation?.[c]??`cpu`,n=i.webnnIsGraphOutput;if(e===`cpu`&&n&&n(a,c)){_.push(`ml-tensor-cpu-output`);continue}if(e!==`cpu`&&e!==`cpu-pinned`&&e!==`gpu-buffer`&&e!==`ml-tensor`)throw Error(`Not supported preferred output location: ${e}.`);if(f&&e!==`gpu-buffer`)throw Error(`Not supported preferred output location: ${e}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);_.push(e)}}let v=null;return _.some(e=>e===`gpu-buffer`||e===`ml-tensor`||e===`ml-tensor-cpu-output`)&&(s=i._OrtCreateBinding(a),s===0&&F(`Can't create IO binding.`),v={handle:s,outputPreferredLocations:_,outputPreferredLocationsEncoded:_.map(e=>e===`ml-tensor-cpu-output`?`ml-tensor`:e).map(e=>Nt(e))}),rd.set(a,[a,l,u,v,f,!1]),[a,p,m,h,g]}catch(e){throw l.forEach(e=>i._OrtFree(e)),u.forEach(e=>i._OrtFree(e)),s!==0&&i._OrtReleaseBinding(s)!==0&&F(`Can't release IO binding.`),a!==0&&i._OrtReleaseSession(a)!==0&&F(`Can't release session.`),e}finally{i._free(n),o!==0&&i._OrtReleaseSessionOptions(o)!==0&&F(`Can't release session options.`),c.forEach(e=>i._free(e)),i.unmountExternalData?.()}},cd=e=>{let t=P(),n=rd.get(e);if(!n)throw Error(`cannot release session. invalid session id: ${e}`);let[r,i,a,o,s]=n;o&&(s&&t._OrtClearBoundOutputs(o.handle)!==0&&F(`Can't clear bound outputs.`),t._OrtReleaseBinding(o.handle)!==0&&F(`Can't release IO binding.`)),t.jsepOnReleaseSession?.(e),t.webnnOnReleaseSession?.(e),t.webgpuOnReleaseSession?.(e),i.forEach(e=>t._OrtFree(e)),a.forEach(e=>t._OrtFree(e)),t._OrtReleaseSession(r)!==0&&F(`Can't release session.`),rd.delete(e)},ld=async(e,t,n,r,i,a,o=!1)=>{if(!e){t.push(0);return}let s=P(),c=s.PTR_SIZE,l=e[0],u=e[1],d=e[3],f=d,p,m;if(l===`string`&&(d===`gpu-buffer`||d===`ml-tensor`))throw Error(`String tensor is not supported on GPU.`);if(o&&d!==`gpu-buffer`)throw Error(`External buffer must be provided for input/output index ${a} when enableGraphCapture is true.`);if(d===`gpu-buffer`){let t=e[2].gpuBuffer;m=Ot(Et(l),u);{let e=s.jsepRegisterBuffer;if(!e)throw Error(`Tensor location "gpu-buffer" is not supported without using WebGPU.`);p=e(r,a,t,m)}}else if(d===`ml-tensor`){let t=e[2].mlTensor;m=Ot(Et(l),u);let n=s.webnnRegisterMLTensor;if(!n)throw Error(`Tensor location "ml-tensor" is not supported without using WebNN.`);p=n(r,t,Et(l),u)}else{let t=e[2];if(Array.isArray(t)){m=c*t.length,p=s._malloc(m),n.push(p);for(let e=0;e<t.length;e++){if(typeof t[e]!=`string`)throw TypeError(`tensor data at index ${e} is not a string`);s.setValue(p+e*c,mt(t[e],n),`*`)}}else{let e=s.webnnIsGraphInput,a=s.webnnIsGraphOutput;if(l!==`string`&&e&&a){let o=s.UTF8ToString(i);if(e(r,o)||a(r,o)){let e=Et(l);m=Ot(e,u),f=`ml-tensor`;let n=s.webnnCreateTemporaryTensor,i=s.webnnUploadTensor;if(!n||!i)throw Error(`Tensor location "ml-tensor" is not supported without using WebNN.`);let a=await n(r,e,u);i(a,new Uint8Array(t.buffer,t.byteOffset,t.byteLength)),p=a}else m=t.byteLength,p=s._malloc(m),n.push(p),s.HEAPU8.set(new Uint8Array(t.buffer,t.byteOffset,m),p)}else m=t.byteLength,p=s._malloc(m),n.push(p),s.HEAPU8.set(new Uint8Array(t.buffer,t.byteOffset,m),p)}}let h=s.stackSave(),g=s.stackAlloc(4*u.length);try{u.forEach((e,t)=>s.setValue(g+t*c,e,c===4?`i32`:`i64`));let e=s._OrtCreateTensor(Et(l),p,m,g,u.length,Nt(f));e===0&&F(`Can't create tensor for input/output. session=${r}, index=${a}.`),t.push(e)}finally{s.stackRestore(h)}},ud=async(e,t,n,r,i,a)=>{let o=P(),s=o.PTR_SIZE,c=rd.get(e);if(!c)throw Error(`cannot run inference. invalid session id: ${e}`);let l=c[0],u=c[1],d=c[2],f=c[3],p=c[4],m=c[5],h=t.length,g=r.length,_=0,v=[],y=[],b=[],x=[],S=[],C=o.stackSave(),w=o.stackAlloc(h*s),T=o.stackAlloc(h*s),E=o.stackAlloc(g*s),D=o.stackAlloc(g*s);try{[_,v]=_t(a),Se(`wasm prepareInputOutputTensor`);for(let r=0;r<h;r++)await ld(n[r],y,x,e,u[t[r]],t[r],p);for(let t=0;t<g;t++)await ld(i[t],b,x,e,d[r[t]],h+r[t],p);Ce(`wasm prepareInputOutputTensor`);for(let e=0;e<h;e++)o.setValue(w+e*s,y[e],`*`),o.setValue(T+e*s,u[t[e]],`*`);for(let e=0;e<g;e++)o.setValue(E+e*s,b[e],`*`),o.setValue(D+e*s,d[r[e]],`*`);if(f&&!m){let{handle:n,outputPreferredLocations:a,outputPreferredLocationsEncoded:s}=f;if(u.length!==h)throw Error(`input count from feeds (${h}) is expected to be always equal to model's input count (${u.length}).`);Se(`wasm bindInputsOutputs`);for(let r=0;r<h;r++){let i=t[r];await o._OrtBindInput(n,u[i],y[r])!==0&&F(`Can't bind input[${r}] for session=${e}.`)}for(let t=0;t<g;t++){let c=r[t];i[t]?.[3]?(S.push(b[t]),o._OrtBindOutput(n,d[c],b[t],0)!==0&&F(`Can't bind pre-allocated output[${t}] for session=${e}.`)):o._OrtBindOutput(n,d[c],0,s[c])!==0&&F(`Can't bind output[${t}] to ${a[t]} for session=${e}.`)}Ce(`wasm bindInputsOutputs`),rd.set(e,[l,u,d,f,p,!0])}o.jsepOnRunStart?.(l),o.webnnOnRunStart?.(l);let c;c=f?await o._OrtRunWithBinding(l,f.handle,g,E,_):await o._OrtRun(l,T,w,h,D,g,E,_),c!==0&&F(`failed to call OrtRun().`);let C=[],O=[];Se(`wasm ProcessOutputTensor`);for(let t=0;t<g;t++){let n=Number(o.getValue(E+t*s,`*`));if(n===b[t]||S.includes(b[t])){C.push(i[t]),n!==b[t]&&o._OrtReleaseTensor(n)!==0&&F(`Can't release tensor.`);continue}let a=o.stackSave(),c=o.stackAlloc(4*s),l=!1,u,d=0;try{o._OrtGetTensorData(n,c,c+s,c+2*s,c+3*s)!==0&&F(`Can't access output tensor data on index ${t}.`);let i=s===4?`i32`:`i64`,a=Number(o.getValue(c,i));d=o.getValue(c+s,`*`);let p=o.getValue(c+s*2,`*`),m=Number(o.getValue(c+s*3,i)),h=[];for(let e=0;e<m;e++)h.push(Number(o.getValue(p+e*s,i)));o._OrtFree(p)!==0&&F(`Can't free memory for tensor dims.`);let g=h.reduce((e,t)=>e*t,1);u=Dt(a);let _=f?.outputPreferredLocations[r[t]];if(u===`string`){if(_===`gpu-buffer`||_===`ml-tensor`)throw Error(`String tensor is not supported on GPU.`);let e=[];for(let t=0;t<g;t++){let n=o.getValue(d+t*s,`*`),r=o.getValue(d+(t+1)*s,`*`),i=t===g-1?void 0:r-n;e.push(o.UTF8ToString(n,i))}C.push([u,h,e,`cpu`])}else if(_===`gpu-buffer`&&g>0){let e=o.jsepGetBuffer;if(!e)throw Error(`preferredLocation "gpu-buffer" is not supported without using WebGPU.`);let t=e(d),r=Ot(a,g);if(r===void 0||!jt(u))throw Error(`Unsupported data type: ${u}`);l=!0,C.push([u,h,{gpuBuffer:t,download:o.jsepCreateDownloader(t,r,u),dispose:()=>{o._OrtReleaseTensor(n)!==0&&F(`Can't release tensor.`)}},`gpu-buffer`])}else if(_===`ml-tensor`&&g>0){let t=o.webnnEnsureTensor,r=o.webnnIsGraphInputOutputTypeSupported;if(!t||!r)throw Error(`preferredLocation "ml-tensor" is not supported without using WebNN.`);if(Ot(a,g)===void 0||!Mt(u))throw Error(`Unsupported data type: ${u}`);if(!r(e,u,!1))throw Error(`preferredLocation "ml-tensor" for ${u} output is not supported by current WebNN Context.`);let i=await t(e,d,a,h,!1);l=!0,C.push([u,h,{mlTensor:i,download:o.webnnCreateMLTensorDownloader(d,u),dispose:()=>{o.webnnReleaseTensorId(d),o._OrtReleaseTensor(n)}},`ml-tensor`])}else if(_===`ml-tensor-cpu-output`&&g>0){let e=o.webnnCreateMLTensorDownloader(d,u)(),t=C.length;l=!0,O.push((async()=>{let r=[t,await e];return o.webnnReleaseTensorId(d),o._OrtReleaseTensor(n),r})()),C.push([u,h,[],`cpu`])}else{let e=new(kt(u))(g);new Uint8Array(e.buffer,e.byteOffset,e.byteLength).set(o.HEAPU8.subarray(d,d+e.byteLength)),C.push([u,h,e,`cpu`])}}finally{o.stackRestore(a),u===`string`&&d&&o._free(d),l||o._OrtReleaseTensor(n)}}f&&!p&&(o._OrtClearBoundOutputs(f.handle)!==0&&F(`Can't clear bound outputs.`),rd.set(e,[l,u,d,f,p,!1]));for(let[e,t]of await Promise.all(O))C[e][2]=t;return Ce(`wasm ProcessOutputTensor`),C}finally{o.webnnOnRunEnd?.(l),o.stackRestore(C),y.forEach(e=>o._OrtReleaseTensor(e)),b.forEach(e=>o._OrtReleaseTensor(e)),x.forEach(e=>o._free(e)),_!==0&&o._OrtReleaseRunOptions(_),v.forEach(e=>o._free(e))}},dd=e=>{let t=P(),n=rd.get(e);if(!n)throw Error(`invalid session id`);let r=n[0],i=t._OrtEndProfiling(r);i===0&&F(`Can't get an profile file name.`),t._OrtFree(i)},fd=e=>{let t=[];for(let n of e){let e=n[2];!Array.isArray(e)&&`buffer`in e&&t.push(e.buffer)}return t}}),md,hd,gd,_d,vd,yd,bd,xd,Sd,Cd,wd,Td,Ed,Dd,Od,kd,Ad,jd,Md=d(()=>{Ne(),pd(),pt(),it(),md=()=>!!D.wasm.proxy&&typeof document<`u`,gd=!1,_d=!1,vd=!1,xd=new Map,Sd=(e,t)=>{let n=xd.get(e);n?n.push(t):xd.set(e,[t])},Cd=()=>{if(gd||!_d||vd||!hd)throw Error(`worker not ready`)},wd=e=>{switch(e.data.type){case`init-wasm`:gd=!1,e.data.err?(vd=!0,bd[1](e.data.err)):(_d=!0,bd[0]()),yd&&=(URL.revokeObjectURL(yd),void 0);break;case`init-ep`:case`copy-from`:case`create`:case`release`:case`run`:case`end-profiling`:{let t=xd.get(e.data.type);e.data.err?t.shift()[1](e.data.err):t.shift()[0](e.data.out);break}}},Td=async()=>{if(!_d){if(gd)throw Error(`multiple calls to 'initWasm()' detected.`);if(vd)throw Error(`previous call to 'initWasm()' failed.`);if(gd=!0,md())return new Promise((e,t)=>{hd?.terminate(),tt().then(([n,r])=>{try{hd=r,hd.onerror=e=>t(e),hd.onmessage=wd,bd=[e,t];let i={type:`init-wasm`,in:D};!i.in.wasm.wasmPaths&&(n||Ke)&&(i.in.wasm.wasmPaths={wasm:new URL(`/lprapp/assets/ort-wasm-simd-threaded.jsep-MDYUKy93.wasm`,``+import.meta.url).href}),hd.postMessage(i),yd=n}catch(e){t(e)}},t)});try{await ft(D.wasm),await td(D),_d=!0}catch(e){throw vd=!0,e}finally{gd=!1}}},Ed=async e=>{if(md())return Cd(),new Promise((t,n)=>{Sd(`init-ep`,[t,n]);let r={type:`init-ep`,in:{epName:e,env:D}};hd.postMessage(r)});await nd(D,e)},Dd=async e=>md()?(Cd(),new Promise((t,n)=>{Sd(`copy-from`,[t,n]);let r={type:`copy-from`,in:{buffer:e}};hd.postMessage(r,[e.buffer])})):od(e),Od=async(e,t)=>{if(md()){if(t?.preferredOutputLocation)throw Error(`session option "preferredOutputLocation" is not supported for proxy.`);return Cd(),new Promise((n,r)=>{Sd(`create`,[n,r]);let i={type:`create`,in:{model:e,options:{...t}}},a=[];e instanceof Uint8Array&&a.push(e.buffer),hd.postMessage(i,a)})}return sd(e,t)},kd=async e=>{if(md())return Cd(),new Promise((t,n)=>{Sd(`release`,[t,n]);let r={type:`release`,in:e};hd.postMessage(r)});cd(e)},Ad=async(e,t,n,r,i,a)=>{if(md()){if(n.some(e=>e[3]!==`cpu`))throw Error(`input tensor on GPU is not supported for proxy.`);if(i.some(e=>e))throw Error(`pre-allocated output tensor is not supported for proxy.`);return Cd(),new Promise((i,o)=>{Sd(`run`,[i,o]);let s=n,c={type:`run`,in:{sessionId:e,inputIndices:t,inputs:s,outputIndices:r,options:a}};hd.postMessage(c,fd(s))})}return ud(e,t,n,r,i,a)},jd=async e=>{if(md())return Cd(),new Promise((t,n)=>{Sd(`end-profiling`,[t,n]);let r={type:`end-profiling`,in:e};hd.postMessage(r)});dd(e)}}),Nd,Pd,Fd,Id=d(()=>{Ne(),Md(),I(),Pe(),Ft(),Nd=(e,t)=>{switch(e.location){case`cpu`:return[e.type,e.dims,e.data,`cpu`];case`gpu-buffer`:return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},`gpu-buffer`];case`ml-tensor`:return[e.type,e.dims,{mlTensor:e.mlTensor},`ml-tensor`];default:throw Error(`invalid data location: ${e.location} for ${t()}`)}},Pd=e=>{switch(e[3]){case`cpu`:return new _e(e[0],e[2],e[1]);case`gpu-buffer`:{let t=e[0];if(!jt(t))throw Error(`not supported data type: ${t} for deserializing GPU tensor`);let{gpuBuffer:n,download:r,dispose:i}=e[2];return _e.fromGpuBuffer(n,{dataType:t,dims:e[1],download:r,dispose:i})}case`ml-tensor`:{let t=e[0];if(!Mt(t))throw Error(`not supported data type: ${t} for deserializing MLTensor tensor`);let{mlTensor:n,download:r,dispose:i}=e[2];return _e.fromMLTensor(n,{dataType:t,dims:e[1],download:r,dispose:i})}default:throw Error(`invalid data location: ${e[3]}`)}},Fd=class{async fetchModelAndCopyToWasmMemory(e){return Dd(await Pt(e))}async loadModel(e,t){be();let n;n=typeof e==`string`?await this.fetchModelAndCopyToWasmMemory(e):e,[this.sessionId,this.inputNames,this.outputNames,this.inputMetadata,this.outputMetadata]=await Od(n,t),xe()}async dispose(){return kd(this.sessionId)}async run(e,t,n){be();let r=[],i=[];Object.entries(e).forEach(e=>{let t=e[0],n=e[1],a=this.inputNames.indexOf(t);if(a===-1)throw Error(`invalid input '${t}'`);r.push(n),i.push(a)});let a=[],o=[];Object.entries(t).forEach(e=>{let t=e[0],n=e[1],r=this.outputNames.indexOf(t);if(r===-1)throw Error(`invalid output '${t}'`);a.push(n),o.push(r)});let s=r.map((e,t)=>Nd(e,()=>`input "${this.inputNames[i[t]]}"`)),c=a.map((e,t)=>e?Nd(e,()=>`output "${this.outputNames[o[t]]}"`):null),l=await Ad(this.sessionId,i,s,o,c,n),u={};for(let e=0;e<l.length;e++)u[this.outputNames[o[e]]]=a[e]??Pd(l[e]);return xe(),u}startProfiling(){}endProfiling(){jd(this.sessionId)}}}),Ld={};f(Ld,{OnnxruntimeWebAssemblyBackend:()=>zd,initializeFlags:()=>Rd,wasmBackend:()=>Bd});var Rd,zd,Bd,Vd=d(()=>{Ne(),Md(),Id(),Rd=()=>{(typeof D.wasm.initTimeout!=`number`||D.wasm.initTimeout<0)&&(D.wasm.initTimeout=0);let e=D.wasm.simd;if(typeof e!=`boolean`&&e!==void 0&&e!==`fixed`&&e!==`relaxed`&&(console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`),D.wasm.simd=!1),typeof D.wasm.proxy!=`boolean`&&(D.wasm.proxy=!1),typeof D.wasm.trace!=`boolean`&&(D.wasm.trace=!1),typeof D.wasm.numThreads!=`number`||!Number.isInteger(D.wasm.numThreads)||D.wasm.numThreads<=0){if(typeof self<`u`&&!self.crossOriginIsolated)D.wasm.numThreads=1;else{let e=typeof navigator>`u`?u(`node:os`).cpus().length:navigator.hardwareConcurrency;D.wasm.numThreads=Math.min(4,Math.ceil((e||1)/2))}}},zd=class{async init(e){Rd(),await Td(),await Ed(e)}async createInferenceSessionHandler(e,t){let n=new Fd;return await n.loadModel(e,t),n}},Bd=new zd});Ne(),Ne(),Ne();var Hd=`1.30.0`;{let e=(Vd(),m(Ld)).wasmBackend;_(`webgpu`,e,5),_(`webnn`,e,5),_(`cpu`,e,10),_(`wasm`,e,10)}Object.defineProperty(D.versions,"web",{value:Hd,enumerable:!0}),D.wasm.numThreads=1;function Ud(e){let t=e.videoWidth||e.naturalWidth||e.width,n=e.videoHeight||e.naturalHeight||e.height;if(!t||!n)return null;let r=t,i=n,a=1080;(r>a||i>a)&&(r>=i?(i=Math.round(i*a/r),r=a):(r=Math.round(r*a/i),i=a));let o=typeof document<`u`?document.createElement(`canvas`):new OffscreenCanvas(r,i);o.width=r,o.height=i;let s=o.getContext(`2d`,{willReadFrequently:!0});return s.imageSmoothingEnabled=!0,s.imageSmoothingQuality=`high`,s.drawImage(e,0,0,r,i),{canvas:o,width:r,height:i,origWidth:t,origHeight:n,scaleX:r/t,scaleY:i/n}}var Wd=document.getElementById(`engineStatusBadge`),Gd=document.getElementById(`engineStatusText`),Kd=document.getElementById(`platesTextarea`),qd=document.getElementById(`btnRecognize`),Jd=document.getElementById(`btnRecognizeText`),Yd=document.getElementById(`cameraSelect`),Xd=document.getElementById(`videoElement`),Zd=document.getElementById(`staticImageElement`),Qd=document.getElementById(`overlayCanvas`),$d=document.getElementById(`viewportContainer`),ef=document.getElementById(`zoomBadge`),tf=document.getElementById(`zoomBadgeText`),nf=document.getElementById(`idleOverlay`),rf=document.getElementById(`btnIdleStart`),af=document.getElementById(`btnIdleSample`),of=document.getElementById(`streamBadge`),sf=document.getElementById(`streamBadgeText`),cf=document.getElementById(`btnTapToDetect`),lf=document.getElementById(`btnTapToDetectText`),uf=document.getElementById(`scanFpsText`),df=document.getElementById(`scanLatencyText`),ff=document.getElementById(`scanResText`),pf=document.getElementById(`sampleSelect`),mf=document.getElementById(`btnPrevSample`),hf=document.getElementById(`btnNextSample`),gf=document.getElementById(`fileInput`),_f=document.getElementById(`btnCloseOverlay`),vf=document.getElementById(`btnMobileSampleCar`),yf=document.getElementById(`mobileFileInput`),bf=document.querySelector(`.right-panel`),xf=document.getElementById(`gpuToggle`),Sf=document.getElementById(`gpuToggleToolbar`),Cf=document.getElementById(`appLoadingOverlay`),wf=document.getElementById(`compItemYolo`),Tf=document.getElementById(`compDescYolo`),Ef=document.getElementById(`compItemPaddle`),Df=document.getElementById(`compDescPaddle`),Of=document.getElementById(`loadingStatusText`),kf=document.getElementById(`loadingErrorBox`),Af=document.getElementById(`loadingErrorMsg`),jf=document.getElementById(`btnDismissLoadingOverlay`);console.log(`[Device] isIOS: false`,{userAgent:typeof navigator<`u`?navigator.userAgent:null,platform:typeof navigator<`u`?navigator.platform:null,maxTouchPoints:typeof navigator<`u`?navigator.maxTouchPoints:null});var Mf=null;function Nf(){return Mf!==null&&Mf}var Pf=`alpr_enable_gpu`,Ff=typeof localStorage<`u`&&localStorage.getItem(Pf)===`true`,If=new Set,Lf=new t({base:`/lprapp/`.replace(/\/$/,``)+`/lpr/`,enableGpu:Ff}),Rf=null,zf=null,Bf=1,Vf=0,Hf=1,Uf=null;typeof window<`u`&&(window.__lprEngine=Lf,window.__fitFrameToMax1080=Ud,window.__matchPlate=$f,window.__getTargetPlates=()=>If,window.__getZoomCapabilities=()=>zf,window.__getCurrentZoom=()=>Bf,window.__applyCameraZoom=e=>np(e),window.__showZoomBadge=e=>rp(e),window.__setMockZoom=(e,t)=>{Rf=e,zf=t},window.__getGpuEnabled=()=>Ff,window.__setGpuEnabled=e=>Sp(e),window.__isIOS=!1,window.__checkIsIOS=Nf,window.__setIsIOS=e=>{Mf=e},window.__triggerManualDetection=()=>dp());var Wf=!1,Gf=null,Kf=!1,qf=null,Jf=0,Yf=performance.now(),Xf=`idle`;function Zf(e){return e?e.toUpperCase().replace(/[^A-Z0-9]/g,``):``}function Qf(e){return Zf(e).replace(/I/g,`1`).replace(/O/g,`0`)}function $f(e,t){let n=Zf(e);if(!n||n.length<2)return{isMatch:!1,matchedPlate:null};if(t.has(n))return{isMatch:!0,matchedPlate:n};let r=Qf(n);for(let e of t)if(Qf(e)===r)return{isMatch:!0,matchedPlate:e};return{isMatch:!1,matchedPlate:null}}function ep(){let e=Kd.value.split(/[\n,;]+/);If.clear();for(let t of e){let e=Zf(t);e.length>=2&&If.add(e)}}async function tp(){if(!navigator.mediaDevices||!navigator.mediaDevices.enumerateDevices){Yd.innerHTML=`<option value="">No Camera API available</option>`;return}try{let e=(await navigator.mediaDevices.enumerateDevices()).filter(e=>e.kind===`videoinput`);if(e.length===0){Yd.innerHTML=`<option value="default">Default Camera</option>`;return}Yd.innerHTML=``;let t=null;e.forEach((e,n)=>{let r=document.createElement(`option`);r.value=e.deviceId;let i=e.label||`Camera ${n+1}`,a=i.toLowerCase();(a.includes(`back`)||a.includes(`rear`)||a.includes(`environment`)||a.includes(`outward`)||a.includes(`world`))&&!t?(t=e.deviceId,r.textContent=`⭐ ${i} (Forward Facing)`):r.textContent=i,Yd.appendChild(r)});let n=document.createElement(`option`);n.value=`prefer-environment`,n.textContent=`🌟 Auto Forward-Facing (Recommended)`,Yd.insertBefore(n,Yd.firstChild),Yd.value=t||`prefer-environment`}catch(e){console.warn(`Could not enumerate cameras:`,e)}}async function np(e){if(!Rf||!zf)return;let t=zf.min??1,n=zf.max??1,r=zf.step??.1,i=Math.round(Math.max(t,Math.min(n,e))/r)*r;Bf=i;try{await Rf.applyConstraints({advanced:[{zoom:i}]})}catch(e){console.warn(`Native camera zoom error:`,e)}rp(i)}function rp(e){ef&&tf&&(tf.textContent=`${Number(e).toFixed(1)}×`,ef.style.display=`flex`,ef.style.opacity=`1`,Uf&&clearTimeout(Uf),Uf=setTimeout(()=>{ef.style.opacity=`0`,setTimeout(()=>{ef.style.opacity===`0`&&(ef.style.display=`none`)},250)},1200))}function ip(){Uf&&=(clearTimeout(Uf),null),ef&&(ef.style.display=`none`)}async function ap(){if(!Wf)try{Wd.className=`status-badge active`,Gd.textContent=`Opening Camera...`;let e=Yd.value,t={width:{ideal:1920,max:1920},height:{ideal:1080,max:1080}};e===`prefer-environment`?t.facingMode={ideal:`environment`}:e?t.deviceId={exact:e}:t.facingMode={ideal:`environment`};try{Gf=await navigator.mediaDevices.getUserMedia({video:{...t,zoom:!0},audio:!1})}catch{Gf=await navigator.mediaDevices.getUserMedia({video:t,audio:!1})}if(Rf=Gf.getVideoTracks()[0]||null,Rf&&typeof Rf.getCapabilities==`function`){let e=Rf.getCapabilities();e&&`zoom`in e?(zf=e.zoom,Bf=(Rf.getSettings?Rf.getSettings():{}).zoom||zf.min||1):zf=null}else zf=null;Xd.srcObject=Gf,Zd.style.display=`none`,Xd.style.display=`block`,await new Promise(e=>{Xd.onloadedmetadata=()=>{Xd.play(),e()}}),Wf=!0,Xf=`camera`,document.body.classList.add(`camera-active-mode`),document.body.classList.remove(`static-active-mode`),nf.style.display=`none`,of.style.display=`flex`,bf&&bf.classList.add(`mobile-active`),qd.classList.add(`is-recognizing`),Jd.textContent=`Stop Streaming`,Nf()?(sf&&(sf.textContent=`TAP TO DETECT`),Wd.className=`status-badge ready`,Gd.textContent=`Camera Ready • Tap to Detect`,uf.textContent=`Tap to Scan`,cf&&(cf.style.display=`flex`,lf&&(lf.textContent=`Tap to Detect`))):(sf&&(sf.textContent=`LIVE RECOGNIZING`),Wd.className=`status-badge active`,Gd.textContent=`Live Streaming & Recognizing`,cf&&(cf.style.display=`none`)),tp(),Jf=0,Yf=performance.now(),sp=0,cp=performance.now(),lp()}catch(e){console.error(`Failed to open camera:`,e),Wd.className=`status-badge ready`,Gd.textContent=`Camera error`,alert(`Could not start camera: ${e.message||e.name}. You can test with the sample car images or upload an image!`),op()}}function op(){qf&&=(cancelAnimationFrame(qf),null),Wf=!1,Kf=!1,Rf=null,zf=null,Bf=1,ip(),cf&&(cf.style.display=`none`),Gf&&=(Gf.getTracks().forEach(e=>e.stop()),null),Xd.srcObject=null,qd.classList.remove(`is-recognizing`),Jd.textContent=`Recognize!`,of.style.display=`none`,bf&&bf.classList.remove(`mobile-active`),document.body.classList.remove(`camera-active-mode`,`static-active-mode`),Xf===`camera`&&(Xf=`idle`,nf.style.display=`flex`,fp()),Jf=0,Yf=performance.now(),Wd.className=`status-badge ready`,Gd.textContent=`Ready`,uf.textContent=`-- FPS`,df.textContent=`-- ms`}var sp=0,cp=performance.now();function lp(){if(!Wf||Xf!==`camera`||Nf())return;let e=performance.now();!Kf&&Xd.readyState>=2&&e>=sp&&up(),qf=requestAnimationFrame(lp)}async function up(){if(Kf)return;Kf=!0;let e=performance.now();try{let t=Xf===`camera`?Xd:Zd,n=Ud(t);if(!n){Kf=!1;return}ff.textContent=`${n.width}×${n.height} (max 1080px)`;let r=await Lf.readAll(n.canvas,{tile:!1});r&&r.length>0&&(cp=performance.now());let i=performance.now(),a=Math.round(i-e);if(df.textContent=`${a} ms`,Nf())uf.textContent=`Manual Tap`;else if(Xf===`camera`){Jf++;let e=i-Yf;if(e>=1e3){let t=Jf*1e3/e;uf.textContent=t<1?`${(e/(Jf*1e3)).toFixed(1)} s/frame`:`${Math.round(t)} FPS`,Jf=0,Yf=i}}else uf.textContent=a>=1e3?`${(a/1e3).toFixed(1)} s/frame`:`-- FPS`;pp(r,n,t)}catch(e){console.error(`Frame processing error:`,e)}finally{Kf=!1;let t=performance.now(),n=Math.round(t-e),r=t-cp>=3e3?1e3:n*2;sp=t+Math.max(r,200)}}async function dp(){if(!Wf||Xf!==`camera`){Wf||await ap();return}if(Kf){console.log(`[iOS Tap] Already processing frame, ignoring tap`);return}if(Xd.readyState<2){console.log(`[iOS Tap] Video not ready yet`);return}console.log(`[iOS Tap] Manual detection triggered by user tap`),$d.classList.remove(`shutter-flash`),$d.offsetWidth,$d.classList.add(`shutter-flash`),setTimeout(()=>{$d.classList.remove(`shutter-flash`)},180),cf&&(cf.classList.add(`is-detecting`),lf&&(lf.textContent=`Detecting...`)),Wd.className=`status-badge active`,Gd.textContent=`Analyzing Frame...`;try{await up()}catch(e){console.error(`Manual detection error:`,e)}finally{cf&&(cf.classList.remove(`is-detecting`),lf&&(lf.textContent=`Tap to Detect`)),Wf&&Xf===`camera`&&(Wd.className=`status-badge ready`,Gd.textContent=`Camera Ready • Tap to Detect`)}}function fp(){Qd.getContext(`2d`).clearRect(0,0,Qd.width,Qd.height)}function pp(e,t,n){let r=document.getElementById(`viewportContainer`).getBoundingClientRect(),i=r.width,a=r.height;if(!i||!a)return;let o=n.videoWidth||n.naturalWidth||n.width||1,s=n.videoHeight||n.naturalHeight||n.height||1,c=Math.min(i/o,a/s),l=o*c,u=s*c,d=(i-l)/2,f=(a-u)/2;Qd.width=i,Qd.height=a;let p=Qd.getContext(`2d`);if(p.clearRect(0,0,Qd.width,Qd.height),!e||e.length===0)return;let m=l/t.width,h=u/t.height,g=e.map(e=>{let t=e.text||``;return{det:e,rawText:t,matchRes:$f(t,If)}}).sort((e,t)=>+!!e.matchRes.isMatch-!!t.matchRes.isMatch);for(let{det:e,rawText:t,matchRes:n}of g){let r=n.isMatch,i=t||n.matchedPlate||`PLATE`,a=e.quad.map(([e,t])=>[d+e*m,f+t*h]),o=a.map(e=>e[0]),s=a.map(e=>e[1]),c=Math.min(...o),l=Math.min(...s),u=Math.max(...o),g=Math.max(...s);u-c,g-l;let _=r?`#10b981`:`#ef4444`,v=r?`rgba(16, 185, 129, 0.16)`:`rgba(239, 68, 68, 0.16)`,y=r?`rgba(16, 185, 129, 0.6)`:`rgba(239, 68, 68, 0.6)`,b=r?`✓`:`✗`,x=r?`MATCH`:`NOT IN LIST`;p.save(),p.shadowColor=y,p.shadowBlur=12,p.strokeStyle=_,p.lineWidth=3.5,p.fillStyle=v,p.beginPath(),p.moveTo(a[0][0],a[0][1]);for(let e=1;e<a.length;e++)p.lineTo(a[e][0],a[e][1]);p.closePath(),p.fill(),p.stroke(),mp(p,a,_),p.shadowBlur=0;let S=`${b} ${i} (${Math.round((e.minConf||0)*100)}%) - ${x}`;p.font=`bold 13px "JetBrains Mono", monospace`;let C=p.measureText(S).width+20,w=(a[0][0]+a[1][0])/2,T=Math.min(a[0][1],a[1][1]),E=Math.max(10,Math.min(Qd.width-C-10,w-C/2)),D=Math.max(10,T-26-8);p.fillStyle=_,hp(p,E,D,C,26,6),p.fill(),p.fillStyle=`#ffffff`,p.textAlign=`left`,p.textBaseline=`middle`,p.fillText(S,E+10,D+13);let O=(a[1][0]+a[2][0])/2,k=(a[1][1]+a[2][1])/2,A=Math.min(Qd.width-14-8,O+14+6),j=k;p.fillStyle=_,p.beginPath(),p.arc(A,j,14,0,Math.PI*2),p.fill(),p.font=`bold 15px "JetBrains Mono", sans-serif`,p.fillStyle=`#ffffff`,p.textAlign=`center`,p.textBaseline=`middle`,p.fillText(b,A,j),p.restore()}}function mp(e,t,n){e.save(),e.strokeStyle=n,e.lineWidth=4,e.lineCap=`round`,e.shadowColor=n,e.shadowBlur=8;let r=t.length;for(let i=0;i<r;i++){let a=t[i],o=t[(i-1+r)%r],s=t[(i+1)%r],c=o[0]-a[0],l=o[1]-a[1],u=Math.hypot(c,l)||1,d=Math.min(18,u*.35),f=s[0]-a[0],p=s[1]-a[1],m=Math.hypot(f,p)||1,h=Math.min(18,m*.35);e.beginPath(),e.moveTo(a[0],a[1]),e.lineTo(a[0]+c/u*d,a[1]+l/u*d),e.stroke(),e.beginPath(),e.moveTo(a[0],a[1]),e.lineTo(a[0]+f/m*h,a[1]+p/m*h),e.stroke(),e.beginPath(),e.arc(a[0],a[1],2,0,Math.PI*2),e.fillStyle=n,e.fill()}e.restore()}function hp(e,t,n,r,i,a){e.beginPath(),e.moveTo(t+a,n),e.arcTo(t+r,n,t+r,n+i,a),e.arcTo(t+r,n+i,t,n+i,a),e.arcTo(t,n+i,t,n,a),e.arcTo(t,n,t+r,n,a),e.closePath()}async function gp(e){Wf&&op(),Xf=`static`,Jf=0,Yf=performance.now(),document.body.classList.add(`static-active-mode`),document.body.classList.remove(`camera-active-mode`),bf&&bf.classList.add(`mobile-active`),nf.style.display=`none`,Xd.style.display=`none`,Zd.style.display=`block`,Wd.className=`status-badge active`,Gd.textContent=`Downsampling to 1080px...`;let t=new Image;t.crossOrigin=`anonymous`,t.onload=async()=>{let e=Ud(t);e&&(Zd.onload=async()=>{Gd.textContent=`Analyzing 1080px Frame...`,await up(),Wd.className=`status-badge ready`,Gd.textContent=`Image Analyzed (1080px View)`},Zd.src=e.canvas.toDataURL(`image/jpeg`,.95))},t.src=e.startsWith(`data:`)||e.startsWith(`blob:`)||e.startsWith(`http://`)||e.startsWith(`https://`)?e:`/lprapp/`.replace(/\/$/,``)+(e.startsWith(`/`)?e:`/`+e)}qd.addEventListener(`click`,()=>{Wf?op():ap()}),rf.addEventListener(`click`,()=>{ap()}),af.addEventListener(`click`,()=>{gp(`/samples/car_cal8942.jpg`)}),Yd.addEventListener(`change`,()=>{Wf&&(op(),ap())}),Kd.addEventListener(`input`,()=>{ep(),Xf!==`idle`&&up()});var _p=[`CAL8942`,`B391KLT`,`SDN6618H`,`SMJ6650C`,`SBU999J`,`SML6579R`,`ES3960A`,`SLX9361E`,`SNF9945S`,`SKG516L`,`SJV7999M`,`SLE5647H`,`SNY9977A`,`SMU5178Z`,`SJS561D`,`SND33T`].join(`
`),vp=0,yp=0,bp=0;$d.addEventListener(`touchstart`,e=>{if(e.touches.length===1&&(vp=performance.now(),yp=e.touches[0].clientX,bp=e.touches[0].clientY),e.touches.length===2&&Xf===`camera`&&zf){e.preventDefault();let t=e.touches[0],n=e.touches[1];Vf=Math.hypot(n.clientX-t.clientX,n.clientY-t.clientY),Hf=Bf}},{passive:!1}),$d.addEventListener(`touchmove`,e=>{if(e.touches.length===2&&Xf===`camera`&&zf&&Vf>0){e.preventDefault();let t=e.touches[0],n=e.touches[1],r=Math.hypot(n.clientX-t.clientX,n.clientY-t.clientY);if(Vf>5){let e=r/Vf;np(Hf*e)}}},{passive:!1}),$d.addEventListener(`touchend`,e=>{if(e.touches.length===0&&Vf===0){let t=performance.now()-vp,n=e.changedTouches[0];if(n){let r=Math.hypot(n.clientX-yp,n.clientY-bp);if(t<350&&r<15){if(e.target.closest(`button, select, input, label`))return;Xf===`camera`&&Nf()&&(e.preventDefault(),dp())}}}e.touches.length<2&&(Vf=0)}),$d.addEventListener(`touchcancel`,()=>{Vf=0}),$d.addEventListener(`click`,e=>{e.target.closest(`button, select, input, label`)||Xf===`camera`&&Nf()&&dp()}),cf&&cf.addEventListener(`click`,e=>{e.stopPropagation(),dp()}),$d.addEventListener(`wheel`,e=>{if(e.ctrlKey&&Xf===`camera`&&zf){e.preventDefault();let t=e.deltaY<0?1.05:.95;np(Bf*t)}},{passive:!1}),pf.addEventListener(`change`,()=>{let e=pf.value;e&&gp(e)}),mf.addEventListener(`click`,()=>{let e=pf.options.length,t=pf.selectedIndex-1;t<0&&(t=e-1),pf.selectedIndex=t,gp(pf.value)}),hf.addEventListener(`click`,()=>{let e=pf.options.length;pf.selectedIndex=(pf.selectedIndex+1)%e,gp(pf.value)}),gf.addEventListener(`change`,e=>{let t=e.target.files&&e.target.files[0];if(t){let e=new FileReader;e.onload=e=>{gp(e.target.result)},e.readAsDataURL(t)}}),_f?.addEventListener(`click`,()=>{Wf?op():(Xf=`idle`,document.body.classList.remove(`camera-active-mode`,`static-active-mode`),bf&&bf.classList.remove(`mobile-active`),Zd.style.display=`none`,nf.style.display=`flex`,fp(),Wd.className=`status-badge ready`,Gd.textContent=`Ready`)}),vf?.addEventListener(`click`,()=>{gp(`/samples/car_cal8942.jpg`)}),yf?.addEventListener(`change`,e=>{let t=e.target.files&&e.target.files[0];if(t){let e=new FileReader;e.onload=e=>{gp(e.target.result)},e.readAsDataURL(t)}}),window.addEventListener(`resize`,()=>{Xf!==`idle`&&up()});function xp(e){xf&&(xf.checked=e,xf.closest(`.gpu-checkbox-label`)?.classList.toggle(`is-active`,e)),Sf&&(Sf.checked=e,Sf.closest(`.gpu-checkbox-label`)?.classList.toggle(`is-active`,e))}async function Sp(e){Ff=!!e;try{localStorage.setItem(Pf,String(Ff))}catch{}xp(Ff),Wd.className=`status-badge loading`,Gd.textContent=Ff?`Switching YOLO to WebGPU...`:`Switching YOLO to WASM...`;try{let e=await Lf.setEnableGpu(Ff,e=>{Gd.textContent=e});if(e&&e.reverted){Ff=!1;try{localStorage.setItem(Pf,`false`)}catch{}xp(!1),Wd.className=`status-badge ready`,Gd.textContent=`WebGPU unavailable; on WASM`,alert(`WebGPU is not supported or encountered an initialization error on this browser/GPU. Reverted to WASM.`)}else Wd.className=`status-badge ready`,Gd.textContent=`YOLO ready on ${Ff?`WebGPU`:`WASM`}`}catch(e){console.error(`Failed to change GPU provider:`,e),Ff=!1;try{localStorage.setItem(Pf,`false`)}catch{}xp(!1),Wd.className=`status-badge ready`,Gd.textContent=`Ready (WASM)`}}xp(Ff),xf?.addEventListener(`change`,e=>Sp(e.target.checked)),Sf?.addEventListener(`change`,e=>Sp(e.target.checked));function Cp(e){if(!Of)return;let t=typeof e==`string`?e:e?.text||JSON.stringify(e);Of.textContent=t;let n=t.toLowerCase();n.includes(`yolo`)||n.includes(`spotter`)||n.includes(`detector`)||n.includes(`webassembly`)||n.includes(`runtime`)?(wf&&(wf.className=`comp-item loading`),Tf&&(Tf.textContent=t)):n.includes(`paddle`)||n.includes(`ocr`)?(wf&&(wf.className=`comp-item ready`),Tf&&(Tf.textContent=`Detector Ready (1 CPU)`),Ef&&(Ef.className=`comp-item loading`),Df&&(Df.textContent=t)):(n.includes(`ready`)||n.includes(`done`))&&(wf&&(wf.className=`comp-item ready`),Tf&&(Tf.textContent=`Detector Ready`),Ef&&(Ef.className=`comp-item ready`),Df&&(Df.textContent=`PP-OCRv6 Engine Ready`))}function wp(){Cf&&(wf&&(wf.className=`comp-item ready`,Tf&&(Tf.textContent=`Detector Ready`)),Ef&&(Ef.className=`comp-item ready`,Df&&(Df.textContent=`PP-OCRv6 Engine Ready`)),Of&&(Of.textContent=`All components loaded!`),setTimeout(()=>{Cf.classList.add(`hidden`),setTimeout(()=>{Cf.style.display=`none`},450)},400))}function Tp(e){kf&&Af&&(Af.textContent=`Initialization note: ${e}`,kf.style.display=`block`),Of&&(Of.textContent=`Engine initialization note`)}jf?.addEventListener(`click`,()=>{Cf&&(Cf.classList.add(`hidden`),setTimeout(()=>{Cf.style.display=`none`},450))});async function Ep(){Kd.value=_p,ep(),await tp();try{if(await Lf.init(e=>{Gd.textContent=typeof e==`string`?e:e?.text||``,Cp(e)}),typeof Lf.enableGpu==`boolean`&&Lf.enableGpu!==Ff){Ff=Lf.enableGpu;try{localStorage.setItem(Pf,String(Ff))}catch{}xp(Ff)}Wd.className=`status-badge ready`,Gd.textContent=`Models Ready (${Ff?`WebGPU`:`WASM`})`,qd.disabled=!1,wp()}catch(e){console.error(`Failed to initialize engine:`,e),Wd.className=`status-badge ready`,Gd.textContent=`Wasm Ready (On-Demand)`,qd.disabled=!1,Tp(e.message||String(e))}}Ep();